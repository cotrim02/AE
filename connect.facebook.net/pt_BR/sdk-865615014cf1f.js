/*1760128893,,JIT Construction: v1028270380,pt_BR*/
...
try {
        ...
        for (var i = 0; i < sandboxSafelist.length; i++) {
            ...
            with(this) {
                ...
                __d("JSSDKRuntimeConfig", [], {
                    ...
                    "sdkab": null,
                    "sdkns": "",
                    "sdkurl": "https:\/\/connect.facebook.net\/pt_BR\/sdk.js",
                    ...
                    var n = c("Type").extend({
                        ...
                        o = {
                            ...
                            _createMobileLoader: function() {
                                var a = document.createElement("div");
                                c("sdk.UA").nativeApp() ? a.innerHTML = '<div class="dialog_header"></div>' : o.isTabletStyle() ? a.innerHTML = '<div class="overlayLoader"><div id="fb_dialog_loader_spinner"></div><a id="fb_dialog_loader_close" href="#">' + c("sdk.fbt")._( /*BTDS*/ "Cancelar") + "</a></div>" : a.innerHTML = '<div class="dialog_header"><table>  <tbody>    <tr>      <td class="header_left">        <label class="touchable_button">          <input type="submit" value="' + c("sdk.fbt")._( /*BTDS*/ "Cancelar") + '"            id="fb_dialog_loader_close"/>        </label>      </td>      <td class="header_center">        <div>         ' + c("sdk.fbt")._( /*BTDS*/ "Carregando...") + '        </div>      </td>      <td class="header_right">      </td>    </tr>  </tbody></table></div>';
                                return o.create({
                ...
                __d("sdk.SharedStringConstants", ["sdk.fbt"], (function(a, b, c, d, e, f, g) {
                    "use strict";
                    b = {
                        continueWith: (a = c("sdk.fbt"))._( /*BTDS*/ "Continuar com {facebook_app_name} ou {instagram_app_name}"),
                        continueWithShort: a._( /*BTDS*/ "{facebook_app_name} ou {instagram_app_name}"),
                        loginButtonAriaLabel: a._( /*BTDS*/ "Continuar com o Facebook ou o Instagram"),
                        logout: a._( /*BTDS*/ "Sair"),
                        logoutButtonAriaLabel: a._( /*BTDS*/ "Sair do site atual"),
                        titleText: a._( /*BTDS*/ "Escolher conta"),
                        promptText: a._( /*BTDS*/ "Qual conta voc\u00ea gostaria de usar para entrar?"),
                        facebookText: a._( /*BTDS*/ "Entrar com o Facebook"),
                        facebookTextShort: a._( /*BTDS*/ "Log in"),
                        instagramText: a._( /*BTDS*/ "Entrar com o Instagram"),
                        disambiguationDialogAriaLabelText: a._( /*BTDS*/ "Log in with Facebook or Instagram"),
                        fbButtonText: a._( /*BTDS*/ "Continuar com o Facebook"),
                        igButtonText: a._( /*BTDS*/ "Continuar com o Instagram")
                    };
    ...
    __fb_i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + __fb_err.name + '","line":"' + (__fb_err.lineNumber || __fb_err.line) + '","script":"' + (__fb_err.fileName || __fb_err.sourceURL || __fb_err.script || "sdk.js") + '","stack":"' + (__fb_err.stackTrace || __fb_err.stack) + '","revision":"1028270380","namespace":"FB","message":"' + __fb_err.message + '"}}');
