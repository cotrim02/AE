...
__d("BanzaiUtils", ["BanzaiConsts", "FBLogger", "cr:1172", "cr:9985", "cr:9986"], (function(a, b, c, d, e, f) {
    ...
    var g, h = {
        ...
        wrapData: function(a, c, d, e, f) {
            a = [a, c, d, 0, f != null ? f : c ? JSON.stringify(c).length : 0];
            a.__meta = {
...
__d("BanzaiAdapterWWW", ["invariant", "Arbiter", "BanzaiConfig", "BanzaiConsts", "BanzaiStorage", "ExecutionEnvironment", "HasteBitMapName", "QueryString", "Run", "TimeSlice", "URI", "UserAgent", "ZeroRewrites", "getAsyncHeaders", "getAsyncParams", "objectValues", "once"], (function(a, b, c, d, e, f, g, h) {
    var i, j, k, l = [],
        m = new(c("Arbiter"))(),
        n = "/ajax/bz",
        o = "POST",
        p = {
            ...
            getEndPointUrl: function(a) {
                var b = c("getAsyncParams")(o);
                c("objectValues")(c("HasteBitMapName")).forEach(function(a) {
                    return delete b[a]
                });
                a = c("QueryString").appendToUrl(n, b);
            ...
            send: function(a, b, e, f) {
                ...
                (j || (j = c("ExecutionEnvironment"))).isInWorker && (g = g.getQualifiedURI());
                ...
                h.onreadystatechange = function() {
                    if (h.readyState >= 4) {
                        ...
                        a == 200 ? (b && b(), f || p.inform((k || (k = c("BanzaiConsts"))).OK)) : (e && e(a), f || p.inform((k || (k = c("BanzaiConsts"))).ERROR))
                    }
                };
                l.push(h);
                h.send(a, !1)
...
__d("SnappyCompressUtil", ["SnappyCompress"], (function(a, b, c, d, e, f, g) {
    "use strict";
    var h = a.Uint8Array,
        i = a.btoa,
        j = a.TextEncoder;
    ...
    function b(a) {
        ...
        var b = null;
        try {
            b = c("SnappyCompress").compress(a)
        } catch (a) {
            return null
        }
        a = Array.from(b, function(a) {
            return String.fromCharCode(a)
        }).join("");
        return i(a)
    }
    var k = {
        compressUint8ArrayToSnappy: b,
        compressStringToSnappy: function(b) {
            ...
            return k.compressUint8ArrayToSnappy(c)
        },
        compressStringToSnappyBinary: function(a) {
            if (h == null) return null;
            var b = null;
            if (j != null) b = new j().encode(a);
            else {
                b = new h(a.length);
        ...
        j = {
            ...
            outOfBandsPosts: function(a) {
                var b = 0,
                    c = {};
                for (a of a) {
                    var d = a.compression === "snappy" || a.compression === "deflate";
                    if (d) {
                        d = new Blob([a.posts], {
...
__d("BanzaiBase", ["BanzaiCompressionUtils", "BanzaiConsts", "BanzaiLazyQueue", "BanzaiUtils", "ErrorGuard", "ExecutionEnvironment", "FBLogger", "Run", "cr:1172", "cr:2037", "cr:3724", "cr:9985", "cr:9986", "cr:9987", "cr:9988", "setIntervalAcrossTransitions"], (function(a, b, c, d, e, f) {
    var g, h, i, j, k, l = [],
        m = null,
        n = {
            ...
            _initialize: function() {
                if ((g || (g = b("ExecutionEnvironment"))).canUseDOM) {
                    var a = n.adapter.useBeacon,
                        c = n.isEnabled("base_flush_lazy_queue");
                    c && b("setIntervalAcrossTransitions")(function() {
                        return n._flushLazyQueue()
                    }, 3e4);
                    if (a && b("cr:9988").isSupported()) {
                        var d;
                        (d = b("cr:9988")).addListener(d.HIDDEN, function() {
                            c && n._flushLazyQueue(), a && n._getPostBuffer().length > 0 && (n._tryToSendViaBeacon() || n._store())
                        });
                        d.addListener(d.VISIBLE, function() {
                            c && n._flushLazyQueue(), a && (n._tryToSendViaBeacon() || n._restore())
                        })
                    } else n.adapter.setHooks(n);
                    n.adapter.setUnloadHook(n);
                    b("cr:9987").addListener(b("cr:9987").Events.NAVIGATION_DONE, function(a, c) {
                        if (c.pageType !== "normal") return;
                        n._restore();
                        b("cr:9987").removeCurrentListener()
                    });
                    c && b("Run").onBeforeUnload(function() {
                        n._flushLazyQueue()
                    })
                }
            },
            ...
            post: function(a, c, d) {
                ...
                var j = b("BanzaiUtils").wrapData(a, c, n._getEventTime(), f, h),
                    k = j;
                d != null && d.callback && (k.__meta.callback = d == null ? void 0 : d.callback);
...
__d("IntlCLDRNumberType34", ["IntlVariations"], (function(a, b, c, d, e, f, g) {
    ...
    a = {
        getVariation: function(a) {
            if (a === 0) return c("IntlVariations").NUMBER_ZERO;
            else if (a === 1) return c("IntlVariations").NUMBER_ONE;
            else if (a === 2) return c("IntlVariations").NUMBER_TWO;
            else if (a % 100 >= 3 && a % 100 <= 10) return c("IntlVariations").NUMBER_FEW;
            else if (a % 100 >= 11 && a % 100 <= 99) return c("IntlVariations").NUMBER_MANY;
            else return c("IntlVariations").NUMBER_OTHER
        }
    };
    b = a;
...
__d("getFbtResult", ["FbtResult", "FbtResultGK", "InlineFbtResult", "getUnwrappedFbt", "gkx", "recoverableViolation"], (function(a, b, c, d, e, f, g) {
    c("gkx")("20935") && c("FbtResultGK").inlineMode === "TRANSLATION" && c("recoverableViolation")("TransAppInlineMode=TRANSLATION should not happen on Comet yet. " + ("[inlineMode=" + (c("FbtResultGK").inlineMode != null ? c("FbtResultGK").inlineMode : "") + "]") + ("[runtime_site_is_comet=" + String(c("gkx")("20935")) + "]"), "internationalization");
