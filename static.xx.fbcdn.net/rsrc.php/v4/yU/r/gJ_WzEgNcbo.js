                ...
                if (e) {
                    d = function() {
                        var c = f[0],
                            d = f[1];
                        try {
                            typeof c === "function" ? c.call(b, a) : c && typeof c.handleEvent === "function" && c.handleEvent(a)
                        } catch (a) {
                            setTimeout(function() {
                                throw a
                            })
...
(function() {
    if (!Array.prototype.flat) {
        var a = function(b) {
            return b < 1 ? Array.prototype.slice.call(this) : Array.prototype.reduce.call(this, function(c, d) {
                Array.isArray(d) ? c.push.apply(c, a.call(d, b - 1)) : c.push(d);
                return c
            }, [])
        };
...
function polyfillIteratorFunctions() {
    var a = new Set();
    getIterables().forEach(function(b) {
        a.add(getIterableProto(b))
    });
    a.forEach(function(a) {
        typeof a.drop !== "function" && (a.drop = function(a) {
            for (var b = 0; b < a; b++) this.next();
            return this
        }), typeof a.every !== "function" && (a.every = function(a) {
            var b = 0;
            for (var c of this)
                if (!a(c, b++)) return !1;
            return !0
        }), typeof a.filter !== "function" && (a.filter = function*(a) {
            var b = 0;
            for (var c of this) a(c, b++) && (yield c)
        }), typeof a.find !== "function" && (a.find = function(a) {
            var b = 0;
            for (var c of this)
                if (a(c, b++)) return c
        }), typeof a.flatMap !== "function" && (a.flatMap = function*(a) {
            var b = 0;
            for (var c of this) {
                var d = a(c, b++);
                "next" in d || (d = d[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]());
                var e = d.next();
                while (!e.done) yield e.value, e = d.next()
            }
        }), typeof a.forEach !== "function" && (a.forEach = function(a) {
            var b = 0;
            for (var c of this) a(c, b++)
        }), typeof a.map !== "function" && (a.map = function*(a) {
            var b = 0;
            for (var c of this) yield a(c, b++)
        }), typeof a.reduce !== "function" && (a.reduce = function(a, b) {
            b = b;
            var c = 0;
            for (var d of this) b = a(b, d, c++);
            return b
        }), typeof a.some !== "function" && (a.some = function(a) {
            var b = 0;
            for (var c of this)
                if (a(c, b++)) return !0;
            return !1
        }), typeof a.take !== "function" && (a.take = function*(a) {
            var b = 0;
            for (var c of this) {
                if (b++ >= a) break;
                yield c
            }
        }), typeof a.toArray !== "function" && (a.toArray = function() {
...
"use strict";
Set.prototype.difference == null && (Set.prototype.difference = function(a) {
    var b = new Set(this);
    for (a of a) b.has(a) && b["delete"](a);
    return b
});
"use strict";
Set.prototype.intersection == null && (Set.prototype.intersection = function(a) {
    var b = new Set();
    for (var c of this) a.has(c) && b.add(c);
    return b
});
"use strict";
Set.prototype.isDisjointFrom == null && (Set.prototype.isDisjointFrom = function(a) {
    if (this.size <= a.size) {
        for (var b of this)
            if (a.has(b)) return !1
    } else
        for (b of a)
            if (this.has(b)) return !1;
    return !0
});
"use strict";
Set.prototype.isSubsetOf == null && (Set.prototype.isSubsetOf = function(a) {
...
"use strict";
Set.prototype.isSupersetOf == null && (Set.prototype.isSupersetOf = function(a) {
    if (this.size < a.size) return !1;
    for (a of a)
...
"use strict";
Set.prototype.symmetricDifference == null && (Set.prototype.symmetricDifference = function(a) {
    var b = new Set(this);
...
(function(a) {
    ...
    function I(d) {
        ...
        a.__onBeforeModuleFactory == null || a.__onBeforeModuleFactory(g);
        var i, j;
        if (g.hasError)
            if (g.error == null) throw w('Requiring module "%s" which threw an exception', d);
            else {
                h = J(g.error);
                K(h, {
        ...
        if (!V(g)) throw w('Requiring module "%s" with unresolved dependencies: %s', d, v([d]));
        M(g);
        h = g.exports = {};
        var k = g.factory,
            l = g.dependencies;
        if (u.call(k) === "[object Function]" && l != null) {
            ...
            p && (g.exports = p);
            var B;
            g.special & ba ? g.exports != null && t.call(g.exports, "default") && (g.defaultExport = B = g.exports["default"]) : g.defaultExport = B = g.exports;
            if (typeof B === "function") {
                n = B.__superConstructor__;
                if (!B.displayName || n && n.displayName === B.displayName) try {
        ...
        x = e[h];
        x && !V(x) && T(h, ca);
        a.__onAfterModuleFactory == null || a.__onAfterModuleFactory(g)
    }

    function J(b) {
        if (a.getErrorSafe != null) return a.getErrorSafe(b);
        return b != null && typeof b === "object" && typeof b.message === "string" ? b : w("Non-error thrown: %s", String(b))
    }
    ...
    function ia(a) {
        !(a in e) && !(a in Q) && (Q[a] = A()), R || (R = setTimeout(Z()(ja, "_checkFbtVirtualModuleTimeout"), S))
    }
    ...
    function T(b, c, e, g, h, i, l) {
        c === void 0 ? (c = [], e = b, b = oa()) : e === void 0 && (e = c, u.call(b) === "[object Array]" ? (c = b, b = oa(c.join(","))) : c = []);
        var m = {
    ...
    function U(a, b, c, d) {
        ...
        return T("__requireLazy__" + e, a, Z()(b, "requireLazy", {
            propagationType: 0
        }), d | l | p, c, 1)
    }
    ...
    function qa(a) {
        ...
        if (!b) throw w("Called _replaceCycleLinkWithSCCDeps on an undefined module");
        h++;
        pa(b, [], a);
        a.depPosition++;
        W(a)
    ...
    X("ifRequired", za);
    X("ifRequireable", Aa);
    b = [F.call(null, "global"), F.call(null, "require"), F.call(null, "requireDynamic"), F.call(null, "requireLazy"), F.call(null, "requireInterop"), null];
    c = [F.call(null, "global"), F.call(null, "require"), F.call(null, "importDefault"), F.call(null, "importNamespace"), F.call(null, "requireLazy"), F.call(null, "requireInterop"), null];
    T.amd = {};
    a.define = T;
    a.require = F;
    a.requireInterop = F;
...
__d("fb-error", ["performanceNow", "removeFromArray"], (function(a, b, c, d, e, f) {
    ...
    var Da = 20,
        Ea = function() {
            ...
            b.tags = function(b) {
                b = b.concat(Array.from(this.loggerTags));
            ...
            b.getTagString = function() {
                var a = this.loggerTags.size > 0 ? "[" + Array.from(this.loggerTags).join("|") + "] " : "";
                return a
            };
            return a
        }();
...
__d("Arbiter", ["invariant", "ArbiterToken", "CallbackDependencyManager", "ErrorGuard", "EventEmitter", "EventEmitterWithHolding", "EventHolder"], (function(a, b, c, d, e, f, g, h) {
    ...
    var l = function() {
        ...
        m = function(a) {
            ...
            c.holdEvent = function(b) {
                var c = this.$ArbiterEventHolder1[b];
                c !== "persistent" && this.$ArbiterEventHolder2(b);
                if (c !== "event") {
                    var d;
                    for (var e = arguments.length, f = new Array(e > 1 ? e - 1 : 0), g = 1; g < e; g++) f[g - 1] = arguments[g];
                    return (d = a.prototype.holdEvent).call.apply(d, [this, b].concat(f))
                }
                return void 0
            };
            ...
            c.releaseEvent = function(b) {
                b && a.prototype.releaseEvent.call(this, b)
            };
            return b
        }(c("EventHolder"));
    l.call(l);
...
__d("BigPipePlugins", ["cr:6669"], (function(a, b, c, d, e, f, g) {
    a = function() {
        ...
        a.getPluginList = function() {
            return [a.moveAdsTokens]
        };
        a.moveAdsTokens = function(b) {
            if (!b) return;
            b = b.querySelectorAll("div[data-fte]");
            for (var c = 0, d = b.length; c < d; c++) a.$1(b[c], "data-ft", "data-ft")
        };
        a.$1 = function(a, c, d) {
...
__d("BootloaderEvents", ["Arbiter", "objectValues"], (function(a, b, c, d, e, f, g) {
    var h = "bootloader/bootload",
        i = "bootloader/bootload_started",
        j = "bootloader/callback_timeout",
        k = "bootloader/defer_timeout",
        l = "hasteResponse/handle",
        m = "bootloader/resource_in_longtail_bt_manifest",
        n = "bootloader/bootload_error",
        o = new(c("Arbiter"))(),
        p = new Set(),
        q = new Set(),
        r = !1;
    ...
    function d(a) {
        p.add(a), o.inform(i, a, "persistent")
    }

    function e(a) {
        p["delete"](a), o.inform(h, a, "persistent")
    }
    ...
    function t(a, b, c) {
        o.inform(s(a, b), c, "persistent")
    }

    function u(a) {
        o.inform(k, a, "persistent")
    }

    function v(a) {
        return o.subscribe(i, function(b, c) {
            return a(c)
        })
    }

    function w(a) {
        return o.subscribe(h, function(b, c) {
            return a(c)
        })
    }

    function x(a) {
        return o.subscribe(k, function(b, c) {
            return a(c)
        })
    }
    ...
    function z(a) {
        o.inform(l, a, "persistent")
    }

    function A(a) {
        return o.subscribe(l, function(b, c) {
            b = s(c.source, c.sourceDetail);
            if (q.has(b)) {
                o.subscribe(b, function(b, d) {
    ...
    function B(a) {
        return o.subscribe(m, function(b, c) {
            a(c)
        })
    }
    ...
    function E(a) {
        return o.subscribe(j, function(b, c) {
            a(c)
        })
    }

    function F(a) {
        o.inform(j, a, "persistent")
    }

    function G(a) {
        return o.subscribe(n, function(b, c) {
            return a(c)
        })
    }

    function H(a) {
        o.inform(n, a, "persistent")
    }
    ...
    g.notifyHasteResponseEF = t;
    g.notifyDeferTimeout = u;
    g.onBootloadStarted = v;
    g.onBootload = w;
    g.onDeferTimeout = x;
    g.getActiveBootloads = y;
    g.notifyHasteResponse = z;
    g.onHasteResponse = A;
    g.onResourceInLongTailBTManifest = B;
    g.getHasDetectedResourceInLongTailBTManifest = C;
    g.notifyResourceInLongTailBTManifest = D;
    g.onBootloaderCallbackTimeout = E;
    g.notifyBootloaderCallbackTimeout = F;
    g.onBootloadError = G;
    g.notifyBootloadError = H
}), 98);
...
__d("BootloaderPreloader", ["invariant", "BootloaderDocumentInserter", "ErrorGuard", "ExecutionEnvironment", "FBLogger", "nullthrows"], (function(a, b, c, d, e, f, g, h) {
    "use strict";
    var i, j, k = new Set(),
        l = new Set();

    function a(a) {
        var b, e = a.allResources,
            f = a == null || (b = a.hsrp) == null || (b = b.hblp) == null ? void 0 : b.rsrcMap;
        if (f == null) {
    ...
    function m(a, b, d, e, f) {
        ...
        d === "preload" ? k.add(a.src) : d === "prefetch" ? l.add(a.src) : h(0, 77517);
        if (a.d === 1) return;
        var m = document.createElement("link");
        f != null && (m.onerror = (j || (j = c("ErrorGuard"))).guard(function() {
            f()
        }));
        m.href = a.src;
        m.rel = d;
        ...
        k = {
            ...
            runCSSPolls: function() {
                ...
                if (b != null && Date.now() >= b) {
                    for (b of j.values()) c("FBLogger")("CSSPoller").warn("Failed to poll CSS: %s with CORS setting %s after %d attempts", b.link.href, b.link.crossOrigin, b.pollAttempts), a.push(b.onError);
                    j.clear()
                } else
                    for (b of j) {
                        var d = b[0],
                        ...
                        try {
                            ...
                            if (g != null) {
                                ...
                                i != null && (a.push(e.onLoad), j["delete"](d))
                            }
                        } catch (a) {
                            e.pollAttempts++, c("FBLogger")("CSSPoller").catching(a).warn("Poll technique was unable to poll CSS: %s with CORS setting %s at attempt %d", f.href, f.crossOrigin, e.pollAttempts)
                        }
                    }
                if (!(h || (h = c("isEmpty")))(a)) {
...
__d("URI", ["Env", "FBLogger", "PHPQuerySerializer", "PHPQuerySerializerNoEncoding", "ReloadPage", "URIBase", "UriNeedRawQuerySVChecker", "cr:1078", "cr:1080", "ifRequired", "isFacebookURI", "memoize", "memoizeStringOnly", "unqualifyURI"], (function(a, b, c, d, e, f, g) {
    ...
    var m = function(e) {
        ...
        g.getUnqualifiedURI = function() {
            return c("unqualifyURI")(new f(this))
        };
        g.getQualifiedURI = function() {
            return new f(this).qualify()
        };
        g.isSameOrigin = function(a) {
            a = a;
            a == null ? a = k() : a instanceof f || (a = new f(a.toString()));
            return e.prototype.isSameOrigin.call(this, a)
        };
        f.goURIOnNewWindow = function(a) {
            f.goURIOnWindow(a, window.open("", "_blank"), !0)
        };
        f.goURIOnWindow = function(a, b, c, d) {
            c === void 0 && (c = !1), d === void 0 && (d = !1), f.goURIOnWindowWithReference(a, b, c, d)
        };
        f.goURIOnWindowWithReference = function(b, e, g, h) {
            g === void 0 && (g = !1);
            h === void 0 && (h = !1);
            b = new f(b);
            g = g;
            ...
            j = b.toString();
            b = e ? e : window;
            e = window.location.href === j && b === window;
            !g && a.PageTransitions ? a.PageTransitions.go(j, h) : e ? d("ReloadPage").now() : h ? b.location.replace(j) : b.location.href = j;
            return b
        };
        g.go = function(a, c) {
            if (b("cr:1078")) {
        ...
        f.getRequestURI = function(a, b) {
            ...
            return new f(window.location.href)
        };
        f.getMostRecentURI = function() {
            var a = l();
            return a ? a.getMostRecentURI().getQualifiedURI() : new f(window.location.href)
        };
        f.getNextURI = function() {
            var a = l();
            return a ? a.getNextURI().getQualifiedURI() : new f(window.location.href)
        };
        f.encodeComponent = function(a) {
            return encodeURIComponent(a).replace(/%5D/g, "]").replace(/%5B/g, "[")
        };
        f.decodeComponent = function(a) {
            return decodeURIComponent(a.replace(/\+/g, " "))
        };
        f.normalize = function(a) {
            return a != null && typeof a === "string" ? this.normalizeString(a) : new f(a).toString()
        };
        return f
    }(j || (j = c("URIBase")));
    m.go = function(a, c, d) {
...
__d("ClientConsistency", ["ClientConsistencyEventEmitter", "FBLogger", "SiteData", "requireWeak"], (function(a, b, c, d, e, f) {
    "use strict";
    var g = b("SiteData").client_revision,
        ...
        n = function(c, a) {
            c > 0 && i == null && (b("FBLogger")("client_consistency").debug("Consistency action needed: %s:%s", c, String(a)), i = "multiple_revs"), c === 2 && b("ClientConsistencyEventEmitter").emit("softRefresh", "multiple_revs"), c === 3 && b("ClientConsistencyEventEmitter").emit("hardRefresh", "multiple_revs")
        },
        o = function(a) {
            var b = a.actions;
            a = a.rev;
...
__d("getSameOriginTransport", ["ExecutionEnvironment", "FBLogger", "GHLNetworkLayer", "err", "justknobx"], (function(a, b, c, d, e, f, g) {
    var h, i = null;

    function b() {
        if (!(h || (h = c("ExecutionEnvironment"))).canUseDOM && !(h || (h = c("ExecutionEnvironment"))).isInWorker) throw c("FBLogger")("comet_infra").mustfixThrow("getSameOriginTransport: Same origin transport unavailable in the server environment.");
        try {
            if (i == null) try {
                var b = c("justknobx")._("3323") ? d("GHLNetworkLayer").getGHLXhr() : null;
                b != null ? i = b : i = a.XMLHttpRequest
            } catch (b) {
                c("FBLogger")("ghl").warn("error while getGHLXhr in getSameOriginTransport: %s", b.message), i = a.XMLHttpRequest
            }
            return new i()
        } catch (a) {
...
__d("NetworkStatusImpl", ["NetworkHeartbeat", "performanceNow"], (function(a, b, c, d, e, f, g) {
    ...
    var h, i, j = [],
        ...
        l = k == null || (h = k.navigator) == null ? void 0 : h.onLine,
        m = 2,
        n = 5e3,
        o = [],
        p = [],
...
__d("TrustedTypes", ["Env", "TrustedTypesUtils", "getErrorSafe"], (function(a, b, c, d, e, f, g) {
    "use strict";
    var h;
    ...
    function l(a, b) {
        return function(e) {
            ...
            if ((h || (h = c("Env"))).isTrustedTypesReportOnly) try {
                ...
                d("TrustedTypesUtils").logError("Exception in policy " + a + ": " + c("getErrorSafe")(b).message + ", returning original string.");
    ...
    function m(a, b) {
        ...
        try {
            ...
            d("TrustedTypesUtils").logError("Error creating Trusted Types policy: " + c("getErrorSafe")(a).message)
        }
        return k
    }
...
__d("Bootloader", ["invariant", "BootloaderConfig", "BootloaderDocumentInserter", "BootloaderEndpoint", "BootloaderEvents", "BootloaderEventsManager", "BootloaderPreloader", "BootloaderRetryTracker", "CSSLoader", "ClientConsistency", "ErrorPubSub", "ExecutionEnvironment", "FBLogger", "HasteBitMap", "HasteResourceIndexUtil", "JSResourceReferenceImpl", "MakeHasteTranslations", "NetworkStatus", "RequireDeferredReference", "ResourceHasher", "ResourceTimingsStore", "ServerJsRuntimeEnvironment", "SiteData", "TimeSlice", "TrustedTypesBootloaderDataURIScriptURLPolicy", "TrustedTypesMetaURIScriptURLPolicy", "__debug", "clearTimeout", "cr:696703", "err", "fb-error", "gkx", "ifRequireable", "ifRequired", "nullthrows", "objectKeys", "objectValues", "performanceAbsoluteNow", "performanceNow", "promiseDone", "setTimeoutAcrossTransitions"], (function(a, b, c, d, e, f, g, h) {
    ...
    var i, j, k, l, m = function() {},
        n = new Set(),
        o = new Set(),
        p = !!(T = c("BootloaderConfig")).deferBootloads,
        q = [],
        r = !1,
        s = [],
        t = new Map(),
        ...
        G = new Set(),
        H = !1,
        I = new(c("BootloaderEventsManager"))(),
        J = new Set(),
        K = new(c("BootloaderRetryTracker"))({
            retries: T.jsRetries,
            abortNum: T.jsRetryAbortNum,
            abortTime: T.jsRetryAbortTime,
            abortCallback: function() {
    ...
    function f() {
        ...
        try {
            if (c("gkx")("1174"))
                if (typeof c("NetworkStatus").isOnline === "function" && typeof c("NetworkStatus").onChange === "function") M = !c("NetworkStatus").isOnline(), N = c("NetworkStatus").onChange(function(a) {
                    a = a.online;
                    var b = M;
                    M = !a;
                    c("FBLogger")("bootloader").info("Network status change: was offline %s, now offline %s", b, M);
                    b && a && aa()
                });
                else throw new Error("Network status API is not available")
        } catch (a) {
            c("FBLogger")("bootloader").warn("NetworkStatus is failing")
        }
    }
    f();
    ...
    function aa() {
        ...
        var a = Array.from(L);
        L.clear();
        c("FBLogger")("bootloader").info("Network back online, retrying %s failed resources", a.length);
        $.loadResources(a)
    }

    function ba(a) {
        M && (L.add(a), c("FBLogger")("bootloader").info("Resource %s failed while offline, will retry when network returns", a))
    ...
    function ca(a) {
        ...
        for (a of a) {
            var b = z.get(a);
            if (!b) return !1;
            for (b of [b.r, ((c = b.rdfds) == null ? void 0 : c.r) || [], ((c = b.rds) == null ? void 0 : c.r) || []]) {
                var c;
                for (c of b)
                    if (!A.has(c)) return !1
            }
    ...
    function U(a, b, d) {
        ...
        c("nullthrows")(self.bl_worker_import_wrapper)(f).then(function() {
            var b = K.getNumRetriesForSource(f);
            ...
            K.maybeScheduleRetry(f, function() {
                U(a, b, d)
            }, function() {
                y.set(a, i), c("FBLogger")("bootloader").catching(h).warn("JS loading error [%s] at %s | time: %s | retries: %s | concurrency: %s", a, f, i - e, K.getNumRetriesForSource(f), w.size - x.size), c("NetworkStatus").reportError(), d()
            })
        })
    }
    ...
    function V(a, b, d, e) {
        ...
        b.d ? (f.src = c("TrustedTypesBootloaderDataURIScriptURLPolicy").createScriptURL(b.src), f.nonce = c("BootloaderConfig").nonce) : f.src = c("TrustedTypesMetaURIScriptURLPolicy").createScriptURL(b.src);
        f.async = !0;
        c("BootloaderConfig").enableRetryOnStuckResource && f.setAttribute("fetchPriority", "high");
    ...
    function ea(a, b, d, e) {
        ...
        a.onload = h.bind(void 0, function() {
            k = !0;
            var a = K.getNumRetriesForSource(f);
        ...
        a.onerror = h.bind(void 0, function() {
            ...
            K.maybeScheduleRetry(f, function() {
                var c = a.parentNode;
                c && (y["delete"](b), c.removeChild(a), V(b, d, e, c))
            }, function() {
                c("FBLogger")("bootloader").warn("JS loading error [%s] at %s | time: %s | retries: %s | concurrency: %s", b, f, h - g, K.getNumRetriesForSource(f), w.size - x.size), c("NetworkStatus").reportError(), e()
            })
        });
        c("BootloaderConfig").enableRetryOnStuckResource && c("setTimeoutAcrossTransitions")(h.bind(void 0, function() {
            if (k) return;
            K.maybeRetryImmediately(f, function() {
                var c = a.parentNode;
                c && (c.removeChild(a), V(b, d, e, c))
            }, function() {
                c("FBLogger")("bootloader").warn("JS loading timeout [%s] at %s | retries: %s | concurrency: %s", b, f, K.getNumRetriesForSource(f), w.size - x.size)
            })
        }), 1e4)
    }
    ...
    function fa(a, b, d) {
        return function() {
            c("FBLogger")("bootloader").warn("CSS timeout [%s] at %s | concurrency: %s", a, b.src, w.size - x.size), y.set(a, (j || (j = c("performanceAbsoluteNow")))()), c("NetworkStatus").reportError(), d()
        }
    }
    ...
    function ia(a, b, e, f) {
        if (c("gkx")("15745")) {
            if (w.has(a) && !y.has(a)) return
        } else if (w.has(a)) return;
        y.has(a) && y["delete"](a);
        w.set(a, (j || (j = c("performanceAbsoluteNow")))());
        var g = [];
        if ((b.type === "js" || b.type === "css") && b.p != null && b.d !== 1 && c("BootloaderConfig").hypStep4) {
            ...
            i.forEach(function(b, c) {
                b !== d("HasteResourceIndexUtil").UNKNOWN_RESOURCE_INDEX && B.get(b) !== a ? l.add(c) : b > m && (m = b)
            });
            if (m > c("BootloaderConfig").btCutoffIndex) {
                var n = ga(i, b.src, l, c("BootloaderConfig").btCutoffIndex);
                g.push(n)
            }
            if (l.size === i.length) return;
            else l.size > 0 && (b.src = ha(b.src, l), b.type === "js" && b.tsrc != null && b.tsrc.trim() !== "" && (b.tsrc = ha(c("nullthrows")(b.tsrc), l)))
        }
        ...
        switch (b.type) {
            case "js":
                V(a, b, function() {
                    $.done(a);
                    for (var b of g) d("BootloaderEvents").notifyResourceInLongTailBTManifest(b, f)
                }, e);
                break;
            case "css":
                n = function() {
                ...
                c("CSSLoader").loadStyleSheet(a, b.src, c("nullthrows")(e), !b.nc, b.m, n, fa(a, b, n));
                break;
            case "async":
                d("BootloaderEndpoint").BootloaderEndpoint.load(b.module, b.blocking, a);
                break;
            default:
                b.type, h(0, 3721)
        }
    ...
    function W(a, e, f, g, i) {
        ...
        for (a of Y(a)) {
            ...
            c("gkx")("15745") ? (!w.has(n) || y.has(n)) && j.set(n, o) : w.has(n) || j.set(n, o)
        }
        var r, s;
        ...
        var t = e.onBlocking,
            u = e.onAll,
            v = e.onLog;
        t && I.registerCallback(function() {
            r(t)
        }, i);
        u && I.registerCallback(function() {
            r(u)
        }, l);
        v && I.registerCallback(function() {
            s(function() {
                return v(k)
            })
        }, m);
    ...
    function X(a, b, e) {
        ...
        if (f)
            for (f of d("HasteResourceIndexUtil").parseResourceIndexes(f)) {
                if (f === d("HasteResourceIndexUtil").UNKNOWN_RESOURCE_INDEX) continue;
                (!B.has(f) || e) && B.set(f, a);
                b.c && c("BootloaderConfig").csrOn && d("HasteBitMap").add("__csr", f)
            }
        ja(a)
    }

    function ja(a) {
        c("BootloaderConfig").enableLoadingUnavailableResources && J.has(a) && (J["delete"](a), $.loadResources([a]))
    }

    function ka(a, b) {
        var e = I.bootload(b);
        if (E.has(e)) return [e, null];
        E.add(e);
    ...
    function na(a, b, f, g) {
        ...
        g && c("nullthrows")(D.get(a)).logData.add(g);
        var h = P(a),
            i = h.r,
            k = h.rdfds,
            l = h.rds;
        h = h.be;
        h = S(a) ? da(a, h) : null;
        h == null && I.notify(I.beDone(a));
        W(h != null ? [h].concat(i) : i, {
            onAll: function() {
                return I.notify(I.tierOne(a))
            },
            onLog: function() {
                return I.notify(I.tierOneLog(a))
            }
        ...
        var m = (k == null ? void 0 : k.m) || [],
            n = function(d) {
                W((k == null ? void 0 : k.r) || [], {
                    ...
                    onAll: function() {
                        return I.registerCallback(function() {
                            I.notify(I.tierTwoStart(a)), e.call(null, m.map(c("RequireDeferredReference").getRDModuleName_DO_NOT_USE), function() {
                                return I.notify(I.tierTwo(a))
                            })
                        }, [I.tierOne(a), b])
                    },
                    onLog: function() {
                        return I.notify(I.tierTwoLog(a))
                    }
                }, d, a, g == null ? void 0 : g.tierTwo)
            };
        c("BootloaderConfig").tieredLoadingFromTier != null && c("BootloaderConfig").tieredLoadingFromTier <= 2 ? I.registerCallback(function() {
        ...
        var o = (l == null ? void 0 : l.m) || [],
            p = function(b) {
                W((l == null ? void 0 : l.r) || [], {
                    ...
                    onAll: function() {
                        return I.registerCallback(function() {
                            I.notify(I.tierThreeStart(a)), e.call(null, o.map(c("RequireDeferredReference").getRDModuleName_DO_NOT_USE), function() {
                                return I.notify(I.tierThree(a))
                            })
                        }, [I.tierTwo(a)])
                    },
                    onLog: function() {
                        return I.notify(I.tierThreeLog(a))
                    }
                }, b, a, g == null ? void 0 : g.tierThree)
            };
        c("BootloaderConfig").tieredLoadingFromTier != null && c("BootloaderConfig").tieredLoadingFromTier <= 3 ? I.registerCallback(function() {
    ...
    function Y(a) {
        ...
        for (a of a) {
            ...
            if (!e) {
                J.add(a);
                c("FBLogger")("bootloader").mustfix("Unable to resolve resource %s.", a);
                continue
            }
            var f = void 0;
            if (e.type === "csr") f = d("HasteResourceIndexUtil").parseResourceIndexes(e.src);
            else if (e.p) f = d("HasteResourceIndexUtil").parseResourceIndexes(e.p), f.includes(d("HasteResourceIndexUtil").UNKNOWN_RESOURCE_INDEX) && b.set(a, e), f = f.filter(function(a) {
            ...
            for (e of f) {
                ...
                f = B.get(e);
                if (f == null) {
                    c("FBLogger")("bootloader").mustfix("SoT hash unavailable for hash %s", e);
    ...
    function Z(a) {
        ...
        if (f != null) {
            ...
            g > c("BootloaderConfig").btCutoffIndex && d("BootloaderEvents").notifyResourceInLongTailBTManifest(ga(f, b.src, new Set(), c("BootloaderConfig").btCutoffIndex), "pickupPageResource")
        }
        g = a.getAttribute("data-btmanifest");
        g != null && (b.m = g);
        A.has(e) && !c("BootloaderConfig").silentDups && c("FBLogger")("bootloader").warn("Duplicate resource [%s]: %s", e, b.src);
        X(e, b, !0);
        w.set(e, (j || (j = c("performanceAbsoluteNow")))());
        f = function() {
            return $.done(e)
        };
        g = b.type === "js" ? !a.getAttribute("async") : ((g = a.parentNode) == null ? void 0 : g.tagName) === "HEAD";
        g || window._btldr && window._btldr[e] ? f() : b.type === "js" ? ea(a, e, b, f) : (c("FBLogger")("bootloader").info("Encountered body CSS not handled by BootloaderScriptListener: {\n          hash: '%s',\n          src: '%s',\n          cohort: '%s',\n        }", e, b.src, c("SiteData").pkg_cohort), c("CSSLoader").setupEventListenersForPotentiallyLoadedCSS(e, b.src, d("BootloaderDocumentInserter").getDOMContainerNode(), f, fa(e, b, f), a))
    }
    ...
    function pa() {
        ...
        a.forEach(function(a) {
            ...
            a = a[3];
            a(function() {
                c("FBLogger")("bootloader").info("Support data is ready, executing immediate bootload:", b.join(", ")), $.loadModules.apply($, [b, d, e])
            })
        })
    }
    ...
    var $ = {
        loadModules: function(a, b, f) {
            ...
            if (!ca(g)) {
                ...
                O(g) && !r ? (c("FBLogger")("bootloader").info("Support data is not ready, queuing immediate bootload:", g.join()), q.push([g, k, f, l])) : s.push([g, k, f, l]);
                l = I.bootload(g);
                t.set(l, (l = t.get(l)) != null ? l : (j || (j = c("performanceAbsoluteNow")))());
                return a
            }
            l = ka(f, g);
            var n = l[0],
                o = l[1];
            I.registerCallback(e.bind(null, g, function() {
                o && (o.callbackStart = (j || (j = c("performanceAbsoluteNow")))()), k.apply(void 0, arguments), o && (o.callbackEnd = (j || (j = c("performanceAbsoluteNow")))()), I.notify(n)
            }), g.map(function(a) {
                return I.tierOne(a)
            }));
            d("BootloaderDocumentInserter").batchDOMInsert(function(b) {
                for (var a of g) na(a, n, b, o)
            });
            if (o) {
                l = new Set([n]);
                for (var p of g) l.add(I.beDone(p)), l.add(I.tierThree(p)), l.add(I.tierOneLog(p)), l.add(I.tierTwoLog(p)), l.add(I.tierThreeLog(p));
                I.registerCallback(function() {
                    d("BootloaderEvents").notifyBootload(o)
                }, Array.from(l));
                p = new Set();
                for (l of new Set(g)) p.add(I.beDone(l)), p.add(I.tierOneLog(l)), p.add(I.tierTwoLog(l)), p.add(I.tierThreeLog(l));
                var u = {
                    bootloaderData: o,
                ...
                I.registerCallback(function() {
                    if ($.getErrorCount() > 0) {
                        u.erroredResources.clear();
                        var a = function(a) {
                            for (a of c("objectValues")(a))
                                for (var b of a) {
                                    var d = b[0],
                                        e = b[1],
                                        f = $.getResourceState(d);
                                    f.loadError != null && (ba(d), e.type === "js" || e.type === "css" ? u.erroredResources.add(e.src) : e.type === "async" && u.erroredResources.add(e.module))
                                }
                        };
                        a(o.tierOne);
                        a(o.tierTwo);
                        ...
                        b = c("gkx")("20935") ? !c("NetworkStatus").isOnline() : !window.navigator.onLine;
                        b && (u.offline = !0);
                        d("BootloaderEvents").notifyBootloadError(u)
                    }
                }, Array.from(p));
                c("ifRequireable")("TimeSliceInteraction", function(a) {
        ...
        loadResources: function(a, b) {
            oa(), d("BootloaderDocumentInserter").batchDOMInsert(function(c) {
                return W(a.map(function(a) {
                    return d("ResourceHasher").getValidResourceHash(a)
                }), b != null ? b : Object.freeze({}), c, "loadResources")
            })
        },
        loadTieredResources: function(a, b) {
            var e = c("BootloaderConfig").tieredLoadingFromTier != null && c("BootloaderConfig").tieredLoadingFromTier <= 2,
                ...
                i = function(c) {
                    var e;
                    W(((e = a == null ? void 0 : a.rds) != null ? e : []).map(function(a) {
                        return d("ResourceHasher").getValidResourceHash(a)
                    }), b != null ? b : Object.freeze({}), c, "loadTieredResources")
                },
                j = function(b) {
                    var c;
                    W(((c = a == null ? void 0 : a.rdfds) != null ? c : []).map(function(a) {
                        return d("ResourceHasher").getValidResourceHash(a)
                    }), {
                        onAll: function() {
                            e ? d("BootloaderDocumentInserter").batchDOMInsert(i) : f && (h = !0, g && d("BootloaderDocumentInserter").batchDOMInsert(i))
                        }
                    }, b, "loadTieredResources")
                },
                k = function(b) {
                    var c;
                    W(((c = a == null ? void 0 : a.r) != null ? c : []).map(function(a) {
                        return d("ResourceHasher").getValidResourceHash(a)
                    }), {
                        onAll: function() {
                            e ? d("BootloaderDocumentInserter").batchDOMInsert(j) : f && (g = !0, h && d("BootloaderDocumentInserter").batchDOMInsert(i))
                        }
                    }, b, "loadTieredResources")
                };
        ...
        requestJSResource_UNSAFE_NEEDS_REVIEW_BY_SECURITY_AND_XFN: function(a) {
            ...
            x.set(a, (j || (j = c("performanceAbsoluteNow")))()), I.notify(I.rsrcDone(a))
        },
        beDone: function(a, b, c) {
            for (d of (d = (d = D.get(a)) == null ? void 0 : d.logData) != null ? d : []) {
                var d;
        ...
        handlePayload: function(a, b) {
            ...
            f = (f = (f = a.consistency) == null ? void 0 : f.rev) != null ? f : null;
        ...
        enableBootload: function(a, b) {
            for (var c in a) b && b.comp++, !z.has(c) ? (z.set(c, a[c]), n.has(c) && (n["delete"](c), Q(c))) : b && b.dup_comp++;
            oa();
            p || qa()
        },
        undeferBootloads: function(a) {
            ...
            a && p && d("BootloaderEvents").notifyDeferTimeout({
                componentMapSize: z.size,
                pending: s.map(function(a) {
                    var b = a[0];
                    a[1];
                    var c = a[2];
                    a[3];
        ...
        markComponentsAsImmediate: function(a) {
            for (a of a) z.has(a) ? Q(a) : n.add(a)
        },
        ...
        setResourceMap: function(a, b, e, f) {
            ...
            for (var h in a) {
                ...
                var i = a[h],
                    j = A.get(h);
                !j ? (i.type === "js" && (g = !0), X(h, i, !1)) : (f && f.dup_rsrc++, (j.type === "js" && i.type === "js" || j.type === "css" && i.type === "css") && (i.d && !j.d && (i.type === "js" && (g = !0), i.nonce != null && j.type === "js" && (j.nonce = i.nonce), j.src = i.src, j.d = 1)))
            }
        ...
        getBootloadPendingComponents: function() {
            ...
            for (var b of D) {
                var c = b[0];
                la(c) || a.set(c, $.getComponentDebugState(c))
            }
            return a
        },
        getComponentDebugState: function(a) {
            var b = function(a) {
                return !!I.getEventTime(a)
            };
            return {
                phases: {
                    tierOne: b(I.tierOne(a)),
                    tierOneLog: b(I.tierOneLog(a)),
                    tierTwo: b(I.tierTwo(a)),
                    tierTwoLog: b(I.tierTwoLog(a)),
                    tierThree: b(I.tierThree(a)),
                    tierThreeLog: b(I.tierThreeLog(a)),
                    beDone: b(I.beDone(a)),
                    asyncHash: b(I.rsrcDone(d("ResourceHasher").getAsyncHash(a)))
                },
        ...
        notifyManuallyLoadedResourcesInWorker: function(a, b) {
            var e = function() {
                var e = d("ResourceHasher").getValidResourceHash(f),
                    g = a[e];
                if (g.type === "js" || g.type === "css") {
                    A.has(e) && !c("BootloaderConfig").silentDups && c("FBLogger")("bootloader").warn("Duplicate manual resource [%s]: %s", e, g.src);
                    X(e, g, !0);
                    g.type === "js" && g.tsrc != null && g.tsrc.trim() !== "" && c("promiseDone")(d("MakeHasteTranslations").genFetchAndProcessTranslations(e, c("nullthrows")(g.tsrc)));
                    w.set(e, (j || (j = c("performanceAbsoluteNow")))());
                    var h = function() {
                            return $.done(e)
                        },
                        i = b[e];
                    g.type === "js" && i ? c("promiseDone")(i, h, function() {
                        U(e, g, h)
                    }) : h()
                }
            };
        ...
        getComponentTiming: function(a) {
            var b;
            return {
                tierTwoStart: (b = I.getEventTime(I.tierTwoStart(a))) != null ? b : 0,
                tierTwoEnd: (b = I.getEventTime(I.tierTwo(a))) != null ? b : 0,
                tierThreeStart: (b = I.getEventTime(I.tierThreeStart(a))) != null ? b : 0,
                tierThreeEnd: (b = I.getEventTime(I.tierThree(a))) != null ? b : 0
            }
        },
        ...
        forceFlush: function() {
            d("BootloaderEndpoint").BootloaderEndpoint.forceFlush()
        },
        __debug: {
            componentMap: z,
            DOMAppendedJSHashes: v,
            requestedRsrcIndex: u,
            requested: w,
            resources: A,
            riMap: B,
            retries: K.getAllRetryAttempts_FOR_DEBUG_ONLY(),
            errors: y,
            loaded: x,
            bootloaded: D,
            notAvailableResources: J,
            queuedToMarkAsImmediate: n,
            events: I,
            offlineFailedResources: L,
            _resolveCSRs: Y,
            revMap: C,
    ...
    p && !a.__comet_ssr_is_server_env_DO_NOT_USE && !d("ServerJsRuntimeEnvironment").isRunningServerJsRuntime() && ((l || (l = c("performanceNow")))() > 15e3 ? $.undeferBootloads(!0) : c("setTimeoutAcrossTransitions")(function() {
        $.undeferBootloads(!0)
...
__d("currentCometRouterInstance", [], (function(a, b, c, d, e, f) {
    "use strict";
    var g = null;
...
__d("getTopMostRouteInfo", [], (function(a, b, c, d, e, f) {
    ...
    function a(a) {
        ...
        if (a && a.length > 0) {
            ...
            a.depth;
            a.key;
            a = babelHelpers.objectWithoutPropertiesLoose(a, g);
            return a
        }
        return b ? b : c
    }
...
__d("CurrentCanonicalRoute", ["currentCometRouterInstance", "getTopMostRoute"], (function(a, b, c, d, e, f, g) {
    function a() {
        var a;
        a = (a = d("currentCometRouterInstance").get_THIS_IS_NOT_WHAT_YOU_WANT()) == null ? void 0 : a.getCurrentRouterState();
        if (a != null) {
        ...
        k = {
            ...
            hasThirdPartyConsent: function(a) {
                ...
                if (!(h || (h = c("InitialCookieConsent"))).hasGranularThirdPartyCookieConsent) {
                    var d = i.has(2);
                    for (var e of a)(h || (h = c("InitialCookieConsent"))).exemptedIntegrations.includes(e) ? b.set(e, !0) : b.set(e, d);
                    return b
                }
                for (e of a)(h || (h = c("InitialCookieConsent"))).optedInIntegrations.includes(e) ? b.set(e, !0) : b.set(e, !1);
                return b
            },
...
__d("WebStorage", ["CookieConsent", "FBLogger", "err", "getErrorSafe", "isQuotaExceededError"], (function(a, b, c, d, e, f, g) {
    "use strict";
    var h, i = {},
        j = {},
        k = "localStorage",
    ...
    function p(a) {
        try {
            ...
            c("FBLogger")("web_storage").warn("Failed to get storage for read %s", c("getErrorSafe")(a).message)
        }
        return null
    }
    ...
    function q(a) {
        ...
        try {
            ...
            if (d("isQuotaExceededError").isStorageQuotaExceededError(b, c("getErrorSafe")(e)) === !1) {
                c("FBLogger")("web_storage").catching(c("getErrorSafe")(e)).warn("Failed to get WebStorage of type `%s`", a);
                return null
            }
        }
        return b
    ...
    function r(a) {
        ...
        try {
            ...
            if (d("isQuotaExceededError").isStorageQuotaExceededError(b, c("getErrorSafe")(a)) === !0) return !0
        }
        return !1
    }
    ...
    function t(a, b, d) {
        ...
        try {
            ...
            e = c("err")("%sStorage quota exceeded while setting %s(%s). Items(length) follows: %s", c("getErrorSafe")(g).name ? c("getErrorSafe")(g).name + ": " : "", b, d.length, f.join())
        }
        return e
    }
    a = {
...
__d("getAsyncParams", ["CometPersistQueryParams", "CurrentCanonicalRoute", "CurrentUserInitialData", "DTSGUtils", "Env", "GetAsyncParamsExtraData", "HasteBitMap", "HasteBitMapName", "JSErrorLoggingConfig", "LSD", "ServerJSDefine", "SiteData", "SprinkleConfig", "StaticSiteData", "WebConnectionClassServerGuess", "WebSession", "asyncParams", "cr:8959", "cr:8960", "getAsyncParamsForProfiling", "getAsyncParamsFromCurrentPageURI", "isSocialPlugin", "objectValues", "requireWeak", "uniqueRequestID"], (function(a, b, c, d, e, f, g) {
    ...
    function a(a, e) {
        ...
        e || (g[c("StaticSiteData").jsmod_key] = c("ServerJSDefine").getLoadedModuleHash(), c("objectValues")(c("HasteBitMapName")).forEach(function(a) {
...
__d("BootloaderEndpoint", ["AdsManagerReadRegions", "Bootloader", "BootloaderEndpointConfig", "CSRFGuard", "FBLogger", "HasteResponse", "TimeSlice", "clearImmediate", "fb-error", "getAsyncParams", "getSameOriginTransport", "gkx", "performanceAbsoluteNow", "setImmediateAcrossTransitions"], (function(a, b, c, d, e, f) {
    "use strict";
    ...
    function p(a, c, d, e, f) {
        if (b("gkx")("5163")) {
            var h = (g || (g = b("performanceAbsoluteNow")))();
            for (a of [a, c])
                for (c of a.entries()) {
                    var i = c[0],
                        j = c[1];
                    b("Bootloader").done(j);
                    b("Bootloader").beDone(i, d, o(e, h, f))
                }
        }
    }
    ...
    function a(a, c) {
        var d = {};
        a.size && (d.modules = q(a));
        c.size && (d.nb_modules = q(c));
    ...
    function r(a, c) {
        ...
        var d = v._getURL(a, c);
        w(d) && (d += "&ads_manager_read_regions=true");
        var e = b("getSameOriginTransport")(),
            f = j++,
        ...
        e.onreadystatechange = function() {
            ...
            k(function() {
                ...
                if (g == null) {
                    p(a, c, f, i, d);
                    b("FBLogger")("bootloader").warn('Invalid bootloader response %s, blocking mods: %s; non-blocking mods: %s; "%s"', e.status, q(a), q(c), e.responseText.substr(0, 256));
                    return
                }
                if (g.error) b("FBLogger")("bootloader").warn("Non-fatal error from bootloader endpoint, blocking mods: %s; non-blocking mods: %s", q(a), q(c));
                else if (g.__error) {
                    p(a, c, f, i, d);
                    b("FBLogger")("bootloader").warn("Fatal error from bootloader endpoint, blocking mods: %s; non-blocking mods: %s", q(a), q(c));
                    return
                }
                b("TimeSlice").guard(function() {
                    return s(d, g, a, c, f, i)
    ...
    function s(a, c, d, e, f, h) {
        var i = (g || (g = b("performanceAbsoluteNow")))(),
            j = c.serverGenTime,
            k = c.hrp;
        if (k == null) {
            c = c;
            b("FBLogger")("be_null_hrp").mustfix("Found null hrp, blocking mods: %s; non-blocking mods: %s; response error: %s", q(d), q(e), c.error + ", summary: " + c.errorSummary + ", description: " + c.errorDescription);
            k = c
        }
        b("HasteResponse").handle(k, {
            ...
            onLog: function(c) {
                for (var g of [d, e])
                    for (var k of g.keys()) b("Bootloader").beDone(k, f, babelHelpers["extends"]({
                        requestStart: h,
                        responseStart: i,
                        serverGenTime: j,
                        uri: a
    ...
    var v = {
        load: function(a, c, d) {
            (c ? m : n).set(a, d);
            if (b("BootloaderEndpointConfig").debugNoBatching || u()) {
                t();
                return
            }
            if (l != null) return;
    ...
    function w(a) {
        return window.location.host.includes("adsmanager") && !b("AdsManagerReadRegions").excluded_endpoints.some(function(b) {
            return a.includes(b)
        }) && b("BootloaderEndpointConfig").adsManagerReadRegions ? !0 : !1
    }
    e.exports = {
        BootloaderEndpoint: v,
        shouldRouteToAMReadRegions: w
    }
}), null);
...
__d("ServerJS", ["ContextualComponent", "ErrorGuard", "HasteBitMap", "HasteResourceIndexUtil", "ServerJSDefine", "__debug", "err", "ge", "replaceTransportMarkers"], (function(a, b, c, d, e, f, g) {
    var h, i = 1,
        j = 2,
        k = 16,
        l = 0;
    a = function() {
        ...
        g.$5 = function(a, b, d) {
            this.$3 = b;
            if (a.__guard != null) throw c("err")("ServerJS.handle called on data that has already been handled");
            a.__guard = !0;
        ...
        g.cleanup = function(a) {
            ...
            a ? e.call(null, d, a.guard(function() {}, "SeverJS Cleanup requireLazy", {
            ...
            function g(d) {
                ...
                e = e[2];
                delete this.$4[d];
                g = g ? 'JS::call("' + a + '", "' + g + '", ...)' : 'JS::requireModule("' + a + '")';
                a = b("__debug").debugUnresolvedDependencies([a, d]);
                throw m(c("err")("%s did not fire because it has missing dependencies.\n%s", g, a), e)
            }
            for (a in this.$4)(h || (h = c("ErrorGuard"))).applyWithGuard(g, this, [a], {
                name: "ServerJS:cleanup id: " + a,
                project: "ServerJSCleanup"
            })
        };
        g.$6 = function(a, b, d, e) {
            return (h || (h = c("ErrorGuard"))).applyWithGuard(c("ServerJSDefine").handleDefine, c("ServerJSDefine"), [a, b, d, e, this.$1], {
                name: "JS::define"
            })
        };
        g.$11 = function(a, b, d, e) {
            return (h || (h = c("ErrorGuard"))).applyWithGuard(this.$13, this, [a, b, d, e], {
        ...
        g.$13 = function(a, d, e, f) {
            ...
            e = [n].concat(a || []);
            var q;
            p != null ? q = "__call__" + n + "." + p : f != null ? q = "__call__" + n : q = "__requireModule__" + n;
            q += "__" + l++;
            this.$4[q] = [n, p, o];
            var r = this.$3 && this.$3.bigPipeContext,
                s = (h || (h = c("ErrorGuard"))).guard(function(a) {
                    a = b.call(null, n);
                    delete g.$4[q];
                    f && c("replaceTransportMarkers")({
                        relativeTo: g.$1,
                        bigPipeContext: r
                    }, f);
                    if (p != null) {
                        if (!a[p]) throw m(c("err")('Module %s has no method "%s"', n, p), o)
                    } else if (f != null && typeof a !== "function") throw m(c("err")("Module %s is not a function but was called with args", n), o);
                    var d = p != null ? a[p] : f != null && typeof a === "function" ? a : null;
                    d != null && (d.apply(a, f || []), s.__SMmeta = d.__SMmeta || {}, s.__SMmeta.module = s.__SMmeta.module || n, s.__SMmeta.name = s.__SMmeta.name || p)
                }, {
                    name: p != null ? "JS::call('" + n + "', '" + p + "', ...)" : f != null ? "JS::call('" + n + "', ...)" : "JS::requireModule('" + n + "')"
                });
            d = define(q, e, s, i | k | j, this, 1, this.$3);
            return d
        };
        g.$10 = function(a, b, d, e) {
            (h || (h = c("ErrorGuard"))).applyWithGuard(this.$14, this, [a, b, d, e], {
                name: "JS::instance"
            })
        };
        ...
        g.$7 = function(a, b, d, e) {
            (h || (h = c("ErrorGuard"))).applyWithGuard(this.$15, this, [a, b, d, e], {
                name: "JS::markup"
            })
        };
        ...
        g.$8 = function(a, b, d, e) {
            (h || (h = c("ErrorGuard"))).applyWithGuard(this.$16, this, [a, b, d, e], {
                name: "JS::element"
            })
        };
        ...
        g.$17 = function(a) {
            ...
            a.map(function(a) {
                ...
                var b = a[0];
                a = a[1];
                c("ContextualComponent").register({
                    element: b,
                    isRoot: a
                })
            })
        ...
        g.$12 = function(a) {
            d("HasteResourceIndexUtil").parseResourceIndexes(a).forEach(function(a) {
    ...
    var g, h = b("fb-error").getSimpleHash,
        ...
        j = {
            ...
            handle: function(a, c) {
                ...
                b("BootloaderConfig").tieredLoadingFromTier <= 3 && a != null ? b("Bootloader").loadTieredResources(a, {
                    onBlocking: q,
                    onAll: c,
                    onLog: f
...
__d("ErrorUtils", ["ErrorGuard", "ErrorGuardState", "ErrorNormalizeUtils", "ErrorPubSub", "ErrorSerializer", "getErrorSafe"], (function(a, b, c, d, e, f, g) {
    ...
    d = {
        ...
        applyWithGuard: function(a, b, d, e, f, g) {
            return (h || (h = c("ErrorGuard"))).applyWithGuard(a, b, d != null ? d : [], {
                name: f,
                onNormalizedError: e,
...
__d("UserTimingUtils.shared", ["UserTimingUtils", "asyncToGeneratorRuntime", "performance"], (function(a, b, c, d, e, f, g) {
    "use strict";
...
__d("UserTimingUtils", ["UserTimingUtils.shared", "performance", "performanceNow"], (function(a, b, c, d, e, f, g) {
    ...
    function a(a, b, e, f) {
        if (d("UserTimingUtils.shared").isUserTimingV3Supported()) {
            ...
            if (e != null) {
                var i, j;
                i = (i = b == null || (j = b.detail) == null ? void 0 : j.devtools) != null ? i : void 0;
                i = i != null ? i : {
                ...
                i.track = e;
                e = (f = b == null ? void 0 : b.detail) != null ? f : {
                    devtools: i
                };
...
__d("BigPipe", ["$", "Arbiter", "BigPipeExperiments", "BigPipeInstance", "BigPipePlugins", "Bootloader", "ErrorUtils", "FBLogger", "HasteResponse", "PageEvents", "PageletEventConstsJS", "PageletSet", "ServerJS", "TimeSlice", "TrustedTypesBigPipeMarkupPolicy", "TrustedTypesNoOpPolicy_DO_NOT_USE", "TrustedTypesUnsafeFunctionScriptPolicy_DO_NOT_USE", "UserTimingUtils", "captureUsageSnapshot", "clearTimeout", "cr:135", "fastDeepCopy", "ge", "performanceAbsoluteNow", "performanceNow", "setTimeout", "setTimeoutAcrossTransitions"], (function(a, b, c, d, e, f, g) {
    ...
    var k = console.timeStamp && window.location.search.indexOf("pagelet_ts=1") > 0;
    ...
    e = function() {
        ...
        e._tryRenderingNextPhase = function() {
            ...
            for (a of this._orderedPhases) {
                var b = this._phases[a];
                if (b.begun)
        ...
        e._nextPhase = function() {
            this.config.flush_pagelets_asap ? this._tryRenderingNextPhase() : (this._currentPhase++, this._beginPhase(this._currentPhase))
        };
    ...
    Object.assign(e.prototype, {
        ...
        onPageletArrive: (i || (i = c("ErrorUtils"))).guard(function(a) {
            ...
            var f = a.phase;
            if (a.all_phases)
                for (b of a.all_phases) this._getOrCreatePhase(b);
            b = this._getOrCreatePhase(f);
            b.pagelets.push(a.id);
            ...
            }, b.pagelets.map(function(a) {
                return a + "_displayed"
            }).concat(["phase_begin_" + f]));
            b = this._getPageletRootID(a);
            var g = d("PageletSet").getOrCreatePagelet(b);
            ...
            g.addDestructor(function() {
                delete e._livePagelets[g.id]
            });
            var h, i = [];
            if (a.jsmods) {
                b = a.jsmods.define;
                var j = a.jsmods.instances,
                    k = a.jsmods.markup,
                    l = a.jsmods.pre_display_requires;
                ...
                m = function() {
                    ...
                    o++;
                    h ? e.arbiter.registerCallback(h, [f]) : i.push(f);
            ...
            if (a.display_out_of_phase === "asap") i = i.concat(["first_response_displayed", a.id + "_css_end"]);
                ...
                i = i.concat(["first_response_displayed", a.id + "_css_end", n]);
                var p = !1;
                b = function() {
                    if (p) return;
                    e.arbiter.inform(n, !0, "state")
                };
                this.arbiter.registerCallback(b, ["tti_pagelet_displayed"]);
                this.arbiter.registerCallback(b, ["phase_begin_" + f])
            } else i = i.concat(["phase_begin_" + a.phase, a.id + "_css_end"]);
            (a.display_dependency || []).forEach(function(a) {
                return i.push(a + "_displayed")
            });
            if (a.display_group) {
                j = document.body.getElementsByClassName("pagelet-group");
                for (k = 0; k < j.length; k++) {
                    l = j[k];
                    if (l.id === a.id) break;
                    l.getAttribute("data-display-group") === a.display_group && i.push(l.id + "_displayed")
                }
            }
            ...
            b = [a.id + "_displayed"];
            this.jsNonBlock || b.push(this.domContentEvt);
            this.arbiter.registerCallback(this._downloadJsForPagelet.bind(this, a), b)
...
__d("HTML", ["invariant", "Bootloader", "FBLogger", "createNodesFromMarkup", "emptyFunction", "evalGlobal"], (function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        ...
        c.$7 = function() {
            ...
            var a = this.$1.replace(h, function(a, b, c) {
...
__d("hyperionCore", ["Promise", "__debug", "hyperionGlobals", "hyperionHook"], (function(a, b, c, d, e, f, g) {
    ...
    var x = "__ext",
        ...
        z = function(a) {
            ...
            c.updateDispatcherFunc = function() {
                var a = 0;
                a |= this.onBeforeCallMapper ? 8 : 0;
                a |= this.onBeforeCallObserver ? 4 : 0;
                a |= this.onAfterCallMapper ? 2 : 0;
                a |= this.onAfterCallObserver ? 1 : 0;
                a |= this.onBeforeAndAterCallMapper ? 16 : 0;
                var c = b.dispatcherCtors[a];
                d("hyperionGlobals").assert(!!c, "unhandled interceptor state " + a);
            ...
            c.onBeforeCallMapperRemove = function(a) {
                var b;
                (b = this.onBeforeCallMapper) != null && b.remove(a) && (this.onBeforeCallMapper.hasCallback() || (this.onBeforeCallMapper = null), this.updateDispatcherFunc());
                return a
            };
            ...
            c.onBeforeCallObserverRemove = function(a) {
                var b;
                (b = this.onBeforeCallObserver) != null && b.remove(a) && (this.onBeforeCallObserver.hasCallback() || (this.onBeforeCallObserver = null), this.updateDispatcherFunc());
                return a
            };
            ...
            c.onAfterCallMapperRemove = function(a) {
                var b;
                (b = this.onAfterCallMapper) != null && b.remove(a) && (this.onAfterCallMapper.hasCallback() || (this.onAfterCallMapper = null), this.updateDispatcherFunc());
                return a
            };
            ...
            c.onAfterCallObserverRemove = function(a) {
                var b;
                (b = this.onAfterCallObserver) != null && b.remove(a) && this.updateDispatcherFunc();
                return a
            };
            ...
            c.onBeforeAndAfterCallMapperRemove = function(a) {
                var b;
                (b = this.onBeforeAndAterCallMapper) != null && b.remove(a) && (this.onBeforeAndAterCallMapper.hasCallback() || (this.onBeforeAndAterCallMapper = null), this.updateDispatcherFunc());
                return a
            };
    ...
    var D = function(a) {
        function b(b, c, d, e) {
            d === void 0 && (d = !1);
            b = a.call(this, b, void 0, d) || this;
            b.interceptProperty(c.targetPrototype, !1, e);
            b.status !== 1 && c.addPendingPropertyInterceptor(b);
            return b
        }
        babelHelpers.inheritsLoose(b, a);
        var c = b.prototype;
        c.interceptProperty = function(a, b, c) {
            c = c != null ? c : n(a, this.name);
            if (b) {
                var d;
                c ? c.writable && (c.value || Object.prototype.hasOwnProperty.call(c, "value")) && (d = c.value, delete c.value, delete c.writable, c.get = function() {
                    return d
                }, c.set = function(a) {
                    d = a
                }, c.configurable = !0) : c = {
            ...
            if (c)
                ...
                f && (c.get = function() {
                    ...
                    a !== e.interceptor && e.setOriginal(a);
                    return e.interceptor
                }, B(c.get, e));
                g && (c.set = function(a) {
                    g.call(this, e.interceptor);
                    a !== e.interceptor && a !== e.original && e.setOriginal(a);
                    return e.interceptor
                }, B(c.set, e));
    ...
    function F(a, b, c, d) {
        ...
        c === void 0 && (c = !1);
        var f = E(a, b);
        return (e = f == null ? void 0 : f.interceptor) != null ? e : new(d != null ? d : D)(a, b, c, f)
    }
    ...
    var ka = function(a) {
        function b(b, c) {
            b = a.call(this, b, c, !0) || this;
            b.ctorInterceptor = null;
            return b
        }
        babelHelpers.inheritsLoose(b, a);
        var c = b.prototype;
        c.setOriginal = function(b) {
            this.ctorInterceptor = G(b);
            return a.prototype.setOriginal.call(this, this.ctorInterceptor)
        };
        return b
    }(z);
    ...
    function I(a, b) {
        return b != null && b.useCaseInsensitivePropertyName ? ("" + a).toLocaleLowerCase() : a
    }
    var J = function() {
            function a(a, b) {
            ...
            b.callOnBeforeInterceptObject = function(a) {
                var b;
                (b = this.parentShadowPrototype) == null || b.callOnBeforeInterceptObject(a);
                (b = this.onBeforInterceptObj) == null || b.call(a)
            };
            b.callOnAfterInterceptObject = function(a) {
                var b;
                (b = this.parentShadowPrototype) == null || b.callOnAfterInterceptObject(a);
                (b = this.onAfterInterceptObj) == null || b.call(a)
            };
            b.interceptObjectItself = function(a) {
                var b;
                (b = this.parentShadowPrototype) == null || b.interceptObjectItself(a);
                if (this.pendingPropertyInterceptors)
                    for (b of this.pendingPropertyInterceptors) b.interceptObjectOwnProperties(a)
            };
    ...
    m = function(a) {
        function b(b, c, d) {
            ...
            e.getter = new z(b, c);
            e.setter = new z(b, d);
            e.getter.setData(Y, e);
            e.setter.setData(Y, e);
            return e
        }
        babelHelpers.inheritsLoose(b, a);
        return b
    ...
    var Z = function(a) {
        function b(b, c, d) {
            b = a.call(this, b) || this;
            b.interceptProperty(c.targetPrototype, !1, d);
            b.status !== 1 && c.addPendingPropertyInterceptor(b);
            return b
        }
        babelHelpers.inheritsLoose(b, a);
        ...
        c.interceptProperty = function(a, b, c) {
            ...
            if (b) {
                ...
                c ? c.value && c.writable && (d = c.value, delete c.value, delete c.writable, c.get = b, c.set = e, c.configurable = !0) : c = {
                    get: b,
                    set: e,
                    enumerable: !0,
                    configurable: !0,
            ...
            if (c)
                if (c.get || c.set) {
                    ...
                    e = b.get;
                    a = b.set;
                    e && (this.getter.setOriginal(e), c.get = this.getter.interceptor);
...
__d("hyperionDOM", ["hyperionCore", "hyperionGlobals"], (function(a, b, c, d, e, f, g) {
    ...
    c = function(a) {
        function b(b, c, e) {
            ...
            if (e) {
                g = e.nodeName;
                b = e.nodeType;
                g && j.set(g.toUpperCase(), l);
                b && i.set(b, l)
            }
            if (e != null && e.registerOnPrototype && f) try {
                (h || (h = d("hyperionCore"))).registerShadowPrototype(f, l)
            } catch (a) {}
            return l
        }
        babelHelpers.inheritsLoose(b, a);
    ...
    var w = new c(CSSStyleDeclaration, null, {
    ...
    var ca = function() {
        ...
        da = function(a) {
            function b(b, c, e) {
                c = a.call(this, b, c, e) || this;
                c.raw = new((h || (h = d("hyperionCore"))).AttributeInterceptorBase)(b, function() {
                    return C.getOriginal().call(this, b)
                }, function(a) {
                    return E.getOriginal().call(this, b, a)
                });
                B.setVirtualProperty(b, new ca(c.raw, c));
                I();
                return c
            }
            babelHelpers.inheritsLoose(b, a);
...
__d("Scroll", [], (function(a, b, c, d, e, f) {
    ...
    function a(a) {
        ...
        return g(a, d) ? (d == null || (b = d.body) == null ? void 0 : b.scrollTop) || (d == null || (c = d.documentElement) == null ? void 0 : c.scrollTop) || 0 : a.scrollTop || 0
    }

    function b(a, b) {
        if (a == null) return;
        var c = a.ownerDocument;
        g(a, c) ? (c != null && c.body && (c.body.scrollTop = b || 0), c != null && c.documentElement && (c.documentElement.scrollTop = b || 0)) : a.scrollTop = b || 0
    }

    function c(a) {
        var b, c, d = a.ownerDocument;
        return g(a, d) ? (d == null || (b = d.body) == null ? void 0 : b.scrollLeft) || (d == null || (c = d.documentElement) == null ? void 0 : c.scrollLeft) || 0 : a.scrollLeft || 0
    }

    function d(a, b) {
        var c = a.ownerDocument;
        g(a, c) ? (c != null && c.body && (c.body.scrollLeft = b || 0), c != null && c.documentElement && (c.documentElement.scrollLeft = b || 0)) : a.scrollLeft = b || 0
    }
    f.getTop = a;
    f.setTop = b;
    f.getLeft = c;
...
__d("Event", ["$", "Arbiter", "DOMEvent", "DOMEventListener", "DOMQuery", "DataStore", "ErrorGuard", "ExecutionEnvironment", "FBLogger", "Parent", "Scroll", "TimeSlice", "UserAgent", "dedupString", "fb-error", "getDocumentScrollElement", "getObjectValues"], (function(a, b, c, d, e, f) {
...
__d("PhotoSnowliftLoader", ["Arbiter", "Bootloader", "PageEvents", "getSurfaceAwareContainer", "ifRequired", "snowliftLoadingSpinner"], (function(a, b, c, d, e, f, g) {
    "use strict";
...
__d("CookieStore", ["CookieCoreLoggingConfig", "FBLogger", "Random", "performanceNow"], (function(a, b, c, d, e, f, g) {
    "use strict";
...
__d("WebStorageMutex", ["WebStorage", "clearTimeout", "pageID", "setTimeout"], (function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        ...
        b.$2 = function() {
            var a = l();
            if (!a) return k;
            a = a.getItem("mutex_" + this.name);
            a = (a != null ? a : "").split(":");
            return a && parseInt(a[1], 10) >= Date.now() ? a[0] : null
        };
        b.$3 = function(a) {
            var b = l();
            if (!b) return;
...
__d("PersistedQueue", ["AnalyticsCoreData", "BaseEventEmitter", "ExecutionEnvironment", "Run", "WebStorage", "WebStorageMutex", "cr:8958", "err", "guid", "nullthrows", "performanceAbsoluteNow", "requestAnimationFrame"], (function(a, b, c, d, e, f, g) {
    ...
    if ((j || (j = c("ExecutionEnvironment"))).canUseDOM) {
        var x = d("Run").maybeOnBeforeUnload(function() {
            n.emit("inactive", null), x == null || x.remove()
        }, !1);
...
__d("FalcoLoggerInternal", ["AnalyticsCoreData", "BaseEventEmitter", "FBLogger", "FalcoConsentChecker", "FalcoUtils", "PersistedQueue", "Promise", "Random", "ServerTime", "WebSession", "nullthrows", "performanceAbsoluteNow"], (function(a, b, c, d, e, f, g) {
    ...
    function a(a, b) {
        ...
        for (d of d) {
            var e, f = a + "^$" + d;
            if (o.has(f)) continue;
            e = ((e = (i || (i = c("AnalyticsCoreData"))).use_falco_as_mutex_key) != null ? e : !1) ? c("PersistedQueue").create(a, {
                onLoad: p,
                queueNameSuffix: d,
                application: "falco"
    ...
    function z(a, b, e, f, g, h) {
        ...
        var j = d("FalcoUtils").xorBitmap([0, 0], l);
        j = d("FalcoUtils").xorBitmap(j, m);
        b = {
            name: a,
            policy: b,
            time: e,
...
__d("CookieCore", ["CookieCoreConfig", "CookieDomain", "CookieStore"], (function(a, b, c, d, e, f, g) {
    ...
    function n(a, b, c, d, e, f, g) {
        ...
        j().setCookie(h, a, b, d, g != null ? g : k(), c, e, f)
    }
...
__d("RunBlue", ["Arbiter", "BigPipeInstance", "ContextualComponent", "ExecutionEnvironment", "PageEvents", "TimeSlice", "createCancelableFunction", "emptyFunction", "performanceAbsoluteNow", "recoverableViolation"], (function(a, b, c, d, e, f, g) {
    ...
    function q(a, b) {
        var d = b != null ? b : c("emptyFunction");
    ...
    function u() {
        ...
        (a = window.console) != null && a.timeStamp && window.console.timeStamp('perf_trace {"name": "e2e", "parent": "PageEvents.BIGPIPE_ONLOAD"}');
...
__d("Visibility", ["BaseEventEmitter", "ExecutionEnvironment", "TimeSlice"], (function(a, b, c, d, e, f, g) {
    ...
    a = function(a) {
        function b() {
            var b;
            for (var c = arguments.length, d = new Array(c), e = 0; e < c; e++) d[e] = arguments[e];
            return (b = a.call.apply(a, [this].concat(d)) || this, b.HIDDEN = "hidden", b.VISIBLE = "visible", b.hiddenKey = i, b.hiddenEvent = j, babelHelpers.assertThisInitialized(b)) || babelHelpers.assertThisInitialized(b)
        }
        babelHelpers.inheritsLoose(b, a);
        var d = b.prototype;
        d.isHidden = function() {
...
__d("legacy:css", ["CSS", "mapObject"], (function(a, b, c, d, e, f) {
    var g, h = a.CSS;
    c = (g || (g = b("mapObject")))(h, function(a) {
        return typeof a === "function" ? a.bind(h) : a
    });
    d = g(b("CSS"), function(a) {
        return typeof a === "function" ? a.bind(b("CSS")) : a
    });
    a.CSS = babelHelpers["extends"]({}, d, c)
}), 3);
