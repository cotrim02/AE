...
__d("CometLruCache", ["FBLogger"], (function(a, b, c, d, e, f, g) {
    "use strict";
    var h = function() {
        function a(a, b) {
            this.$1 = a, this.$2 = b, a <= 0 && c("FBLogger")("CometLruCache").mustfix("CometLruCache: Unable to create instance of cache with zero or negative capacity."), this.$3 = new Map()
        }
        var b = a.prototype;
        b.set = function(a, b) {
            this.$3["delete"](a);
...
__d("ConstUriUtils", ["CometLruCache", "ExecutionEnvironment", "FBLogger", "PHPQuerySerializer", "PHPQuerySerializerNoEncoding", "URIRFC3986", "URISchemes", "UriNeedRawQuerySVConfig", "isSameOrigin", "nullthrows", "structuredClone"], (function(a, b, c, d, e, f, g) {
    "use strict";
    var h, i, j, k, l = d("CometLruCache").create(5e3),
        ...
        r = new RegExp("[\\x00-\\x2c\\x2f\\x3b-\\x40\\x5c\\x5e\\x60\\x7b-\\x7f\\uFDD0-\\uFDEF\\uFFF0-\\uFFFF\\u2047\\u2048\\uFE56\\uFE5F\\uFF03\\uFF0F\\uFF1F]"),
    ...
    function x(a) {
        return a != null && s.some(function(b) {
    ...
    function B(a, b, c, d) {
        ...
        b = C(f, a.originalRawQuery, a.queryParams, b, c, d != null ? d : a.serializer);
        c = b.length > 0 ? "?" : "";
    ...
    var F = function() {
        ...
        b.getQualifiedUri = function() {
            if (!this.getDomain()) {
                var b;
                b = (b = typeof window !== "undefined" ? window : self) == null || (b = b.location) == null ? void 0 : b.href;
                if (b == null) {
        ...
        b.getQueryString = function(a) {
            a === void 0 && (a = !1);
            return C(this.domain, this.originalRawQuery, this.queryParams, !1, a, this.serializer)
        };
        ...
        a.getUribyObject = function(b, d) {
            ...
            if (f == null) {
                ...
                if (d.valid) f = new a(d.components), l.set(e, f);
                    ...
                    c("FBLogger")("ConstUri").mustfix(d.error);
                    return null
                }
            }
            return f
        ...
        b.isFacebookUri = function() {
            var a = this.toString();
            if (a === "") return !1;
            return !this.getDomain() && !this.getProtocol() ? !0 : ["https", "http"].indexOf(this.getProtocol()) !== -1 && (m.test(this.getDomain()) || n.test(this.getDomain()) || o.test(this.getDomain()) || p.test(this.getDomain()))
        };
...
__d("jsRouteBuilder", ["ConstUriUtils", "FBLogger", "routeBuilderUtils"], (function(a, b, c, d, e, f, g) {
    ...
    function a(a, b, e, f, g) {
        ...
        function j(j) {
            try {
                var k = f != null ? babelHelpers["extends"]({}, f, j) : j != null ? j : {},
                    l = {};
                j = "";
                var m = !1;
...
__d("AdsManagerConstURIUtils", ["AdsManagerReadRegions", "XAdsCMAccountSettingsPageControllerRouteBuilder", "XAdsCMControllerRouteBuilder", "XAdsPEControllerRouteBuilder", "gkx"], (function(a, b, c, d, e, f, g) {
    ...
    function a(a, b, d) {
        d = c("XAdsPEControllerRouteBuilder").buildUri(babelHelpers["extends"]({}, d, {
            nav_entry_point: b != null ? b : void 0,
            nav_source: a
        }));
        return j(d)
    }
    ...
    function b(a, b, d) {
        d = c("XAdsCMControllerRouteBuilder").buildUri(babelHelpers["extends"]({}, d, {
            nav_entry_point: b != null ? b : void 0,
            nav_source: a
        }));
        return j(d)
    ...
    function d(a, b, d) {
        d = c("XAdsCMAccountSettingsPageControllerRouteBuilder").buildUri(babelHelpers["extends"]({}, d, {
            nav_entry_point: b != null ? b : void 0,
            nav_source: a
        }));
        return j(d)
    ...
    function h(a) {
        return window.location.host.includes("adsmanager") && !c("AdsManagerReadRegions").excluded_endpoints.some(function(b) {
            return a.includes(b)
        }) && c("gkx")("1221") ? !0 : !1
    }
    ...
    function i(a, b) {
        b === void 0 && (b = !0);
        return window.location.host.includes("adsmanager") && c("gkx")("13382") && (c("AdsManagerReadRegions").excluded_endpoints.some(function(b) {
            return a.includes(b)
        }) || !b) ? !0 : !1
    }

    function j(a) {
        h(a.toString()) ? a.addQueryParam("ads_manager_read_regions", "true") : i(a.toString()) ? a.addQueryParam("ads_manager_write_regions", "true") : (a.getQueryParam("ads_manager_read_regions") !== null || a.getQueryParam("ads_manager_write_regions") !== null) && (a.removeQueryParam("ads_manager_read_regions"), a.removeQueryParam("ads_manager_write_regions"));
        return a
    }
    g.getAdsManagerURI = a;
    g.getXAdsCMControllerURI = b;
    g.getXAdsCMAccountSettingsPageURI = d;
    g.shouldRouteToAMReadRegions = h;
    g.shouldRouteToAMWriteRegions = i
}), 98);
...
__d("FbtResultBase", [], (function(a, b, c, d, e, f) {
        ...
        b.$4 = function() {
            ...
            for (var d = 0; d < c.length; ++d) {
                ...
                if (typeof e === "string" || e instanceof a) b += e.toString();
                    ...
                    var f;
                    (f = this.__errorListener) == null || f.onStringSerializationError == null || f.onStringSerializationError(e)
                }
            }
    ...
    ["anchor", "big", "blink", "bold", "charAt", "charCodeAt", "codePointAt", "contains", "endsWith", "fixed", "fontcolor", "fontsize", "includes", "indexOf", "italics", "lastIndexOf", "link", "localeCompare", "match", "normalize", "repeat", "replace", "search", "slice", "small", "split", "startsWith", "strike", "sub", "substr", "substring", "sup", "toLocaleLowerCase", "toLocaleUpperCase", "toLowerCase", "toUpperCase", "trim", "trimLeft", "trimRight"].forEach(function(a) {
        g.prototype[a] = function() {
            var b;
            (b = this.__errorListener) == null || b.onStringMethodUsed == null || b.onStringMethodUsed(a);
...
__d("AsyncResponse", ["invariant", "Bootloader", "FBLogger", "HTML", "WebDriverConfig"], (function(a, b, c, d, e, f, g, h) {
    ...
    a = function() {
        function a(a, b) {
            this.error = 0, this.errorSummary = null, this.errorDescription = null, this.errorMid = null, this.onload = null, this.replay = !1, this.payload = b, this.request = a, this.silentError = !1, this.transientError = !1, this.blockedAction = !1, this.is_last = !0, this.responseHeaders = null
        }
        var b = a.prototype;
...
__d("StreamBlockReader", ["Promise", "asyncToGeneratorRuntime"], (function(a, b, c, d, e, f) {
    var g;
    a = function() {
        function a(a) {
            var c = this;
        ...
        c.$13 = function() {
            var a = b("asyncToGeneratorRuntime").asyncToGenerator(function*() {
                ...
                if (this.isDone()) throw new Error("You cannot read from a stream that is done");
                a = (yield this.$3.read());
                var b = a.done;
                a = a.value;
                this.$4 = b;
                b && this.$8();
                return a ? this.$10().decode(a, {
                    stream: !b
                }) : ""
            });
        ...
        c.readUntilStringOrEnd = function() {
            var a = b("asyncToGeneratorRuntime").asyncToGenerator(function*(a) {
                return yield this.readUntilOneOfStringOrEnd_DO_NOT_USE([a])
            });
        ...
        c.readUntilStringOrThrow = function() {
            var a = b("asyncToGeneratorRuntime").asyncToGenerator(function*(a) {
                if (!a) throw new Error("cannot read empty string");
                this.$11();
                var b = "",
                    c = 0;
                while (!this.isDone()) {
                    ...
                    var d = b.substring(c).indexOf(a);
                    if (d !== -1) {
                        d += c;
                        this.$6 = b.substring(d + a.length);
                        this.$12();
                        return b.substring(0, d)
                    } else c = b.length - a.length + 1
                }
                this.$6 = b;
                this.$12();
        ...
        c.readUntilOneOfStringOrEnd_DO_NOT_USE = function() {
            var a = b("asyncToGeneratorRuntime").asyncToGenerator(function*(a) {
                this.$11();
                var b = "";
                while (!this.isDone()) {
...
__d("mixin", [], (function(a, b, c, d, e, f) {
    function a() {
        ...
        while (e[b]) {
            c = e[b];
            for (var g in c) Object.prototype.hasOwnProperty.call(c, g) && (a.prototype[g] = c[g]);
            b += 1
        }
        return a
    }
...
__d("FetchStreamTransport", ["ArbiterMixin", "FetchStreamConfig", "StreamBlockReader", "TimeSlice", "URI", "asyncToGeneratorRuntime", "mixin", "nullthrows"], (function(a, b, c, d, e, f, g) {
    ...
    a = function(a) {
        function d(b) {
            ...
            return c || babelHelpers.assertThisInitialized(c)
        }
        ...
        e.$FetchStreamTransport$p_7 = function() {
            var a = b("asyncToGeneratorRuntime").asyncToGenerator(function*(a) {
                ...
                a = function*() {
                    ...
                    if (b.$FetchStreamTransport$p_4) return 1;
...
__d("ScriptPath", ["ErrorGuard", "SubscriptionList", "TimeSlice", "WebStorage", "isInIframe"], (function(a, b, c, d, e, f) {
    ...
    c = {
        ...
        getEarlyFlushPage: function() {
            var a;
            return (a = l) == null || (a = a.extraData) == null ? void 0 : a.ef_page
        },
...
__d("FbtErrorListenerWWW", ["FBLogger"], (function(a, b, c, d, e, f, g) {
    a = function() {
        function a(a) {
        ...
        b.onStringSerializationError = function(a) {
            var b, d = "Context not logged.",
                e = (a == null || (b = a.constructor) == null ? void 0 : b.name) || "";
            c("FBLogger")("fbt").blameToPreviousDirectory().blameToPreviousDirectory().mustfix('Converting to a string will drop content data. Hash="%s" Translation="%s" Content="%s" (type=%s,%s)', this.$1, this.$2, d, typeof a, e)
        };
...
__d("getTranslatedInput", ["Env", "ExecutionEnvironment", "FBLogger", "MakeHasteTranslationsMap"], (function(a, b, c, d, e, f, g) {
    ...
    function a(a) {
        ...
        if (k && (i || (i = c("ExecutionEnvironment"))).isInBrowser) {
            if (typeof b === "string") {
                var e = b.match(j);
                if (e != null) return l(babelHelpers["extends"]({}, a, {
    ...
    function l(a) {
        var b = a.table;
        return typeof b === "string" && b[0] === "_" && b[1] === "j" && (b[2] === "{" || b[2] === "[") ? babelHelpers["extends"]({}, a, {
            table: JSON.parse(b.substring(2))
        }) : a
    }
    g["default"] = a
}), 98);
    ...
    function a() {
        ...
        (h || (h = b("FbtHooks"))).register({
            ...
            logImpression: function(a, b) {
                return c("promiseDone")(i.load().then(function(d) {
                    d.logImpression == null || d.logImpression(a);
                    if (!c("justknobx")._("2269")) {
                        var e, f = b == null ? void 0 : b.inputTable;
                        e = (e = b == null ? void 0 : b.tokens) != null ? e : [];
                        if (typeof f === "string") {
                            f = f.match(j);
                            f != null && (d.logImpressionV2 == null || d.logImpressionV2(f[1], e))
                        }
                    }
                }))
            }
...
__d("FbtHooksImpl", [], (function(a, b, c, d, e, f) {
    ...
    a = {
        ...
        logImpression: function(a, b) {
            g.logImpression == null || g.logImpression(a, b)
        },
        onTranslationOverride: function(a) {
            g.onTranslationOverride == null || g.onTranslationOverride(a)
        },
...
__d("IntlPunctuation", ["FbtHooks", "IntlPhonologicalRewrites", "IntlRedundantStops"], (function(a, b, c, d, e, f, g) {
    ...
    for (e in c("IntlRedundantStops").equivalencies)
        for (f of [e].concat(c("IntlRedundantStops").equivalencies[e])) l.set(f, e);
    var m = new Map();
    for (f in c("IntlRedundantStops").redundancies) m.set(f, new Set(c("IntlRedundantStops").redundancies[f]));
...
__d("substituteTokens", ["invariant", "IntlPunctuation"], (function(a, b, c, d, e, f, g, h) {
    ...
    function a(a, b, c) {
        ...
        a = a.replace(j, function(a, g, h) {
            i.call(b, g) || (c == null || c.onMissingParameterError == null || c.onMissingParameterError(Object.keys(b), g));
            a = b[g];
...
__d("fbt", ["invariant", "FbtEnv", "FbtHooks", "FbtQTOverrides", "FbtResultBase", "FbtTable", "FbtTableAccessor", "GenderConst", "IntlVariationResolver", "intlNumUtils", "substituteTokens"], (function(a, b, c, d, e, f, g) {
    ...
    function a(a, c, d) {
        if ((d != null && d.hk || d != null && d.ehk) && m) return {
            text: a,
            fbt: !0,
            hashKey: d.hk
        };
        ...
        l = [];
        e && (typeof c !== "string" && (c = b("FbtTable").access(c, e, 0, l)), f = r(e), c !== null || g(0, 479));
        var n;
        if (Array.isArray(c)) {
            k = c[0];
            n = c[1];
            e = "1_" + n;
            i[e] != null && i[e] !== "" && (k = i[e], (h || (h = b("FbtHooks"))).onTranslationOverride(n));
            e = {
                inputTable: a,
                tokens: l
            };
        ...
        if (a && !l) return a;
            ...
            e = b("substituteTokens")(k, f, (h || (h = b("FbtHooks"))).getErrorListener == null ? void 0 : (h || (h = b("FbtHooks"))).getErrorListener({
                translation: k,
                hash: n
            }));
...
__d("getAsyncHeaders", ["BDHeaderConfig", "LSD", "ZeroCategoryHeader", "isFacebookURI", "requireWeak"], (function(a, b, c, d, e, f, g) {
    ...
    function j(a) {
        var b;
        b = (b = (b = k()) == null || (b = b.location) == null ? void 0 : b.origin) != null ? b : (b = window) == null || (b = b.location) == null ? void 0 : b.origin;
...
__d("isAIDemosDotMetaDotComURI", [], (function(a, b, c, d, e, f) {
    var g = new RegExp("(^|\\.)aidemos\\.meta\\.com$", "i"),
        h = ["https"];
...
__d("isDevelopersDotMetaDotComURI", [], (function(a, b, c, d, e, f) {
    var g = new RegExp("(^|\\.)developers\\.meta\\.com$", "i"),
        h = ["https"];
...
__d("isWearablesDotDeveloperDotMetaDotComURI", [], (function(a, b, c, d, e, f) {
    var g = new RegExp("(^|\\.)wearables?(\\.[^.]+)*\\.developer\\.meta\\.com$", "i"),
        h = ["https"];
    ...
    var F = "for (;;);",
        ...
        H = function() {
            function a(b) {
                ...
                this._dispatchErrorResponse = function(a, b) {
                    ...
                    if (e._isServerDialogErrorCode(d)) {
                        ...
                        d == 1357007 ? e._displayServerDialog(a, f, !0) : e._displayServerDialog(a, f)
            ...
            e._invokeErrorHandler = function(a) {
                ...
                var f, g;
                a = !0;
                if (e === r) g = i._( /*BTDS*/ "Sem conex\u00e3o de rede"), f = i._( /*BTDS*/ "Seu navegador parece estar offline. Verifique sua conex\u00e3o com a internet e tente novamente.");
                else if (e >= 300 && e <= 399) {
                    g = i._( /*BTDS*/ "Redirecionamento");
                    f = i._( /*BTDS*/ "Seu acesso ao Facebook foi redirecionado ou bloqueado por terceiros no momento, entre em contato com seu provedor de servi\u00e7os ou recarregue.");
                    var h = d.getResponseHeader("Location");
                    h && c("goURI")(h, !0);
                    a = !0
                } else g = i._( /*BTDS*/ "Opa!"), f = i._( /*BTDS*/ "Ocorreu um erro. Estamos trabalhando para corrigi-lo o mais r\u00e1pido poss\u00edvel. Voc\u00ea pode tentar novamente.");
                var j = new(c("AsyncResponse"))(this, d);
                h = d.getResponseHeader("Error-Mid");
                Object.assign(j, {
                    error: e,
                    errorSummary: g,
                    errorDescription: f,
                ...
                d = c("FBLogger")("asyncresponse");
                h != null && (d = d.addMetadata("OPES", "MID", h));
                if (!this.transportErrorHandler) {
                    d.mustfix("Async request to %s failed with a %d error, but there was no error handler available to deal with it.", this.getURI(), e);
                    return
                }
                g = this.getTransportErrorHandler().bind(this);
                !(this.getOption("suppressErrorAlerts") || u.has(e)) ? d.addToCategoryKey(String(e)).mustfix("Async request failed with error %s: %s when requesting %s", e, f.toString(), this.getURI()): u.has(e) && d.addToCategoryKey(String(e)).warn("Async request failed with error %s: %s when requesting %s", e, f.toString(), this.getURI());
                (q || (q = c("ErrorGuard"))).applyWithGuard(this._dispatchErrorResponse, this, [j, g])
            };
            ...
            e.send = function(b) {
                ...
                d("AdsManagerConstURIUtils").shouldRouteToAMReadRegions(this.uri.toString()) && this.getReadOnly() && this.method.toLowerCase() === "get" ? this.uri.addQueryData({
                    ads_manager_read_regions: !0
                }) : d("AdsManagerConstURIUtils").shouldRouteToAMWriteRegions(this.uri.toString(), this.getReadOnly()) && this.uri.addQueryData({
                ...
                if (i)
                    for (h in this.headers) Object.prototype.hasOwnProperty.call(this.headers, h) && i.setRequestHeader(h, this.headers[h]);
            ...
            e._canSendCredentials = function() {
                ...
                return c("isFacebookURI")(a) || c("isInternalFBURI")(a) || c("isMessengerDotComURI")(a) || c("isWorkplaceDotComURI")(a) || c("isWorkroomsDotComURI")(a) || c("isWorkDotMetaDotComURI")(a) || c("isHorizonDotMetaDotComURI")(a) || c("isSparkDotMetaDotComURI")(a) || c("isWearablesDotDeveloperDotMetaDotComURI")(a) || c("isDevelopersDotMetaDotComURI")(a) || c("isArDotMetaDotComURI")(a) || c("isAIDemosDotMetaDotComURI")(a) || c("isBugBountyDotMetaDotComURI")(a)
            };
...
__d("getVendorPrefixedName", ["invariant", "ExecutionEnvironment", "UserAgent", "camelize"], (function(a, b, c, d, e, f, g, h) {
    ...
    function o(a) {
        switch (a) {
            case "lineClamp":
                return c("UserAgent").isEngine_DEPRECATED_DANGEROUS("WebKit >= 315.14.2") || c("UserAgent").isEngine("Blink") ? "WebkitLineClamp" : null;
            default:
                return null
        }
    }
...
__d("uuidv4", [], (function(a, b, c, d, e, f) {
    ...
    function a() {
        var a;
        a = (a = self) == null || (a = a.crypto) == null ? void 0 : a.randomUUID;
...
__d("CurrentUser", ["Cookie", "CurrentUserInitialData"], (function(a, b, c, d, e, f) {
    var g, h = {
        ...
        getAbraID: function() {
            var a;
            return (a = (g || (g = b("CurrentUserInitialData"))).ABRA_ID) != null ? a : "0"
        },
        getAbraStorageID: function() {
            var a;
            return (a = (g || (g = b("CurrentUserInitialData"))).ABRA_STORAGE_ID) != null ? a : "0"
        },
        getARID: function() {
            var a;
            return (a = (g || (g = b("CurrentUserInitialData"))).AR_ID) != null ? a : "0"
        },
        getEPOU: function() {
            var a;
        ...
        isManagedMetaAccount: function() {
            return !!(g || (g = b("CurrentUserInitialData"))).IS_MANAGED_META_ACCOUNT
        },
        ...
        isWabaBusinessPerson: function() {
            return (g || (g = b("CurrentUserInitialData"))).IS_WABA_BUSINESS_PERSON
        },
...
__d("getElementRect", ["containsNode", "normalizeBoundingClientRect"], (function(a, b, c, d, e, f, g) {
    function a(a) {
        var b, d = a == null || (b = a.ownerDocument) == null ? void 0 : b.documentElement;
        return !a || !("getBoundingClientRect" in a) || !c("containsNode")(d, a) ? {
            left: 0,
            right: 0,
            top: 0,
            bottom: 0,
...
__d("ViewportBounds", ["Arbiter", "ArbiterMixin", "BlueBar", "ExecutionEnvironment", "PageEvents", "Vector", "emptyFunction", "removeFromArray"], (function(a, b, c, d, e, f) {
    ...
    function a(a) {
        return function() {
            return h[a].reduce(function(a, b) {
    ...
    var i = function() {
        ...
        function a(a, c, d) {
            ...
            }, this.isPersistent = b("emptyFunction").thatReturns(d), h[a].push(this), j.inform("change")
        }
        var c = a.prototype;
        c.remove = function() {
            b("removeFromArray")(h[this.getSide()], this), j.inform("change")
        };
        return a
    }();
    ...
    var j = babelHelpers["extends"]({}, b("ArbiterMixin"), {
        getTop: a("top"),
        getRight: a("right"),
        getBottom: a("bottom"),
        getLeft: a("left"),
    ...
    j.addPersistentTop(function() {
        if ((g || (g = b("ExecutionEnvironment"))).canUseDOM && b("BlueBar").hasFixedBlueBar()) {
...
__d("LayerHideOnEscape", ["CSS", "Event", "Keys", "LayerHideSources"], (function(a, b, c, d, e, f, g) {
    a = function() {
        function a(a) {
            this._layer = a
        }
        ...
        b.handle = function(a, b) {
            if (c("Event").getKeyCode(b) === c("Keys").ESC && !d("CSS").hasClass(this._layer.getRoot(), "hidden_elem")) {
...
__d("LinkController", ["DataStore", "Event", "Parent", "removeFromArray", "trackReferrer"], (function(a, b, c, d, e, f, g) {
    ...
    }(f = c("Event")).listen(document.documentElement, "mousedown", e, f.Priority.URGENT);
    f.listen(document.documentElement, "keydown", e, f.Priority.URGENT);
    g.registerHandler = a;
...
__d("computeRelativeURI", ["URI", "isEmpty", "isFacebookURI"], (function(a, b, c, d, e, f, g) {
    ...
    function a(a, b) {
        ...
        a.forEach(function(a) {
            var b = a === "Path" && g === e;
            b && d.setPath(j(e.getPath(), f.getPath()));
            (i || (i = c("isEmpty")))(f["get" + a]()) || (g = f);
            b || d["set" + a](g["get" + a]())
        });
        return d
    }
...
__d("getReferrerURI", ["ErrorGuard", "URI", "isFacebookURI"], (function(a, b, c, d, e, f, g) {
    ...
    function b() {
        if (a.PageTransitions && a.PageTransitions.isInitialized()) return a.PageTransitions.getReferrerURI();
            ...
            var b = (h || (h = c("ErrorGuard"))).applyWithGuard(function(a) {
...
__d("PageTransitionsRegistrar", ["invariant", "DOMQuery", "Form", "LinkController", "PageTransitionPriorities", "Parent", "URI", "computeRelativeURI", "getReferrerURI", "goURI", "requireDeferred", "setTimeout", "setTimeoutAcrossTransitions"], (function(a, b, c, d, e, f, g, h) {
    var i, j = c("requireDeferred")("PageTransitions").__setRef("PageTransitionsRegistrar");
    c("setTimeout")(function() {
    ...
    e = {
        ...
        registerHandler: function(a, b) {
            a != null || h(0, 5202), b = b || d("PageTransitionPriorities").DEFAULT, k[b] || (k[b] = []), k[b].push(a)
        },
    ...
    function e(a) {
        var b;
        if (m && ((b = m.getAttribute("href")) == null ? void 0 : b[0]) !== "#") {
    ...
    function n(a) {
        var b = a.getAttribute("href") || "",
            d = c("computeRelativeURI")(o().getQualifiedURI().toString(), b).toString();
    ...
    function f(a, b) {
        ...
        var f = new(i || (i = c("URI")))(d("Form").getAttribute(e, "action"));
        f = c("computeRelativeURI")(o().toString(), f.toString());
        ...
        if ((d("Form").getAttribute(e, "method") || "GET").toUpperCase() == "GET") {
            ...
            typeof f === "string" && (f = new(i || (i = c("URI")))(f));
    ...
    function o() {
        if (a.PageTransitions && a.PageTransitions.isInitialized()) return a.PageTransitions.getMostRecentURI();
            ...
            var b = (i || (i = c("URI"))).getRequestURI(!1);
            b = b.getUnqualifiedURI();
            var d = new i(b).setFragment(""),
                e = b.getFragment();
...
__d("PlatformVersioning", ["invariant", "PlatformVersions", "StrSet", "getObjectValues"], (function(a, b, c, d, e, f, g) {
    ...
    function c() {
        return b("PlatformVersions").LATEST_LAUNCHED
    }
    ...
    i = {
        addVersionToPath: k,
        getLatestVersion: a,
        getLatestLaunchedVersion: c,
        versionAwareURI: d,
        versionAwarePath: e,
        getUnversionedPath: l
    };
    a = i;
    f["default"] = a
}), 66);
            ...
            var g = c("resolveWindow")(e.relation.replace(/^parent\./, "")),
                ...
                k = function() {
                    try {
                        ...
                        --j ? window.setTimeout(k, 200) : d("sdk.Scribe").log("jssdk_error", {
                            error: "POST_MESSAGE",
                            extra: {
                                message: b.message + ", html/js/modules/XD.js:139",
...
__d("react-compiler-runtime", [], (function(a, b, c, d, e, f) {
    "use strict";
    var g = null;
...
__d("react-forget-runtime", ["invariant", "DangerouslyAccessReactElementInternals_DO_NOT_USE_IN_NEW_CODE", "FBLogger", "err"], (function(a, b, c, d, e, f, g, h) {
    var i = null,
        j = null,
        k = !1,
        l = a.console,
    ...
    function q(a) {
        if (!k) {
            ...
            l.error(o + a + "\n" + b.stack);
            k = !0;
            c("FBLogger")("React").warn("React compiler guard functions used in production.")
        }
        ...
        n[a] = function() {
            var a = "[React] Unexpected React hook call {name} from a React Forget compiled function. Check that all hooks are called directly and named according to convention ('use[A-Z]') ";
            q(a)
        }
    });
    a = function(a) {
        n[a] = function() {
            if (j == null) throw c("FBLogger")("React").mustfixThrow("React Forget internal error: unexpected null dispatcher");
            else {
                var b;
    ...
    for (var r of ["useMemoCache", "unstable_useMemoCache", "readContext", "unstable_isNewReconciler", "getCacheSignal", "getCacheForType", "use"]) a(r);
    ...
    function b(a) {
        ...
        if (a === 0) {
            ...
            m.length === 1 && (j = b);
            if (b === n) {
                var d = "[React] Unexpected call to custom hook or component from a React Forget compiled function. Check that (1) all hooks are called directly and named according to convention ('use[A-Z]') and (2) components are returned as JSX instead of being directly invoked.";
                q(d)
            }
            i.H = n
        } else if (a === 1) {
            d = m.pop();
            if (d == null) throw c("FBLogger")("React").mustfixThrow("React Forget internal error: unexpected null in guard stack");
            m.length === 0 && (j = null);
            i.H = d
    ...
    function d(a) {
        s = a.isValidElement, i = a.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE
    }
    a = !1;
    ...
    function f(a, b, d, e, f, g) {
        function i(a, b, c, h) {
            c = p + "Forget change detection: " + f + ":" + g + " [" + e + "]: " + d + c + " changed from " + a + " to " + b + " (depth " + h + ")";
            if (u.has(c)) return;
            u.add(c);
            l.error(c)
        }
        ...
        function k(a, b, d, e) {
            ...
            else if (typeof a !== typeof b) i("type " + typeof a, "type " + typeof b, d, e);
            else if (typeof a === "object") {
                typeof b === "object" || h(0, 18576);
                if (a === null || b === null)(a !== null || b !== null) && i("type " + (a === null ? "null" : "object"), "type " + (b === null ? "null" : "object"), d, e);
                else if (a instanceof Map)
                    if (!(b instanceof Map)) i("Map instance", "other value", d, e);
                    else if (a.size !== b.size) i("Map instance with size " + a.size, "Map instance with size " + b.size, d, e);
                else
                    for (var f of a) {
                        var g = f[0],
                            l = f[1];
                        !b.has(g) ? i("Map instance with key " + String(g), "Map instance without key " + String(l), d, e) : k(l, b.get(g), d + ".get(" + String(g) + ")", e + 1)
                    } else if (b instanceof Map) i("other value", "Map instance", d, e);
                    else if (a instanceof Set)
                    if (!(b instanceof Set)) i("Set instance", "other value", d, e);
                    else if (a.size !== b.size) i("Set instance with size " + a.size, "Set instance with size " + b.size, d, e);
                else
                    for (l of b) a.has(l) || i("Set instance without element " + String(l), "Set instance with element " + String(l), d, e);
                else if (b instanceof Set) i("other value", "Set instance", d, e);
                else if (Array.isArray(a) || Array.isArray(b))
                    if (!Array.isArray(a) || !Array.isArray(b)) i("type " + (Array.isArray(a) ? "array" : "object"), "type " + (Array.isArray(b) ? "array" : "object"), d, e);
                    else if (a.length !== b.length) i("array with length " + a.length, "array with length " + b.length, d, e);
                else
                    for (g = 0; g < a.length; g++) k(a[g], b[g], d + "[" + g + "]", e + 1);
                else if (t(a) || t(b)) !t(a) || !t(b) ? i("type " + (t(a) ? "React element" : "object"), "type " + (t(b) ? "React element" : "object"), d, e) : c("DangerouslyAccessReactElementInternals_DO_NOT_USE_IN_NEW_CODE")(a).type !== c("DangerouslyAccessReactElementInternals_DO_NOT_USE_IN_NEW_CODE")(b).type ? i("React element of type " + String(c("DangerouslyAccessReactElementInternals_DO_NOT_USE_IN_NEW_CODE")(a).type.name), "React element of type " + String(c("DangerouslyAccessReactElementInternals_DO_NOT_USE_IN_NEW_CODE")(b).type.name), d, e) : k(c("DangerouslyAccessReactElementInternals_DO_NOT_USE_IN_NEW_CODE")(a).props, c("DangerouslyAccessReactElementInternals_DO_NOT_USE_IN_NEW_CODE")(b).props, "[props of " + d + "]", e + 1);
                else {
                    for (f in b) f in a || i("object without key " + f, "object with key " + f, d, e);
                    for (l in a) !(l in b) ? i("object with key " + l, "object without key " + l, d, e) : k(a[l], b[l], d + "." + l, e + 1)
                }
            } else if (typeof a === "function") return;
            else isNaN(a) || isNaN(b) ? isNaN(a) !== isNaN(b) && i("" + (isNaN(a) ? "NaN" : "non-NaN value"), "" + (isNaN(b) ? "NaN" : "non-NaN value"), d, e) : a !== b && i(String(a), String(b), d, e)
        }
        k(a, b, "", 0)
    }
    g.$dispatcherGuard = b;
...
__d("shimReactSecretInternals_DEPRECATED", ["FBLogger", "justknobx"], (function(a, b, c, d, e, f, g) {
    "use strict";
    var h = new Set();
    ...
    function i(a, b) {
        ...
        if (c("justknobx")._("1806")) {
            ...
            b === "warn" ? d.warn("Access to a renamed property of React's secret internals: %s. A library or hack needs to be updated.", a) : d.mustfix("Access to a renamed property of React's secret internals: %s. A library or hack needs to be updated.", a)
        }
    }

    function a(a) {
        if (!c("justknobx")._("1296")) return;
        ...
        ["ReactCurrentDispatcher", "ReactCurrentCache", "ReactCurrentBatchConfig", "ReactCurrentOwner"].forEach(function(a) {
            var c;
            (c = Object.getOwnPropertyDescriptor(b, a)) != null && c.configurable && Object.defineProperty(b, a, {
                enumerable: !1
            })
        });
...
__d("React", ["FBLogger", "cr:1294158", "cr:15957", "react-compiler-runtime", "react-forget-runtime", "setupReactRefresh", "shimReactSecretInternals_DEPRECATED"], (function(a, b, c, d, e, f) {
    b("setupReactRefresh");
    a = b("cr:1294158");
    b("cr:15957");
    ...
    a.useEffectEvent = a.experimental_useEffectEvent;
    e.exports = a
}), null);
...
__d("XHRRequest", ["invariant", "DTSGUtils", "Env", "ErrorGuard", "FBLogger", "LSD", "Log", "NetworkStatus", "ResourceTimingsStore", "ResourceTypes", "SprinkleConfig", "TimeSlice", "URI", "XHRHttpError", "ZeroRewrites", "cr:8959", "cr:8960", "fb-error", "getAsyncHeaders", "performance", "xhrSimpleDataSerializer"], (function(a, b, c, d, e, f, g) {
    var h, i, j, k, l = b("fb-error").ErrorXFBDebug,
        m = !1,
        n = !1,
        o = {
            loadedBytes: 0,
    ...
    a = function() {
        ...
        function a(a) {
            this.$3 = function() {
                return null
            }, this.$20 = p(a), this.$7 = "POST", this.$6 = {}, this.setResponseType(null), this.setTransportBuilder(b("ZeroRewrites").getTransportBuilderForURI(this.getURI())), this.setDataSerializer(b("xhrSimpleDataSerializer")), this.$12 = b("ResourceTimingsStore").getUID(b("ResourceTypes").XHR, a != null ? a.toString() : "")
        }
        var c = a.prototype;
        c.setURI = function(a) {
            this.$20 = p(a);
        ...
        c.setTransportBuilder = function(a) {
            !this.$18 || !b("ZeroRewrites").isRewritten(this.$20) ? this.$18 = a : b("FBLogger")("iorg-FOS").blameToPreviousFile().mustfix("can not set new TransportBuilder for the request %s", String(this.getURI()));
            return this
        };
        ...
        c.send = function() {
            ...
            this.$9 = d;
            this.$7 === "POST" || !this.$11 || g(0, 2346, this.$11, c);
            ...
            this.$7 === "GET" || this.$11 ? (c.addQueryData(this.$2), e = this.$11) : e = this.$3(this.$2);
            ...
            d.onreadystatechange = this.$22(j);
            d.onerror = this.$23(j);
            d.upload && this.$19 && (d.upload.onprogress = this.$24.bind(this));
            this.$4 && (d.onprogress = this.$25.bind(this));
            a && (this.$17 = setTimeout(this.$26.bind(this), a));
            this.$21 != null && (d.withCredentials = this.$21);
            d.open(this.$7, c.toString(), !0);
            j = !1;
            if (this.$6)
                for (a in this.$6) a.toLowerCase() === "content-type" && (j = !0), d.setRequestHeader(a, this.$6[a]);
            this.$7 == "POST" && !this.$11 && !j && d.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            var k = b("getAsyncHeaders")(c);
            Object.keys(k).forEach(function(a) {
                d.setRequestHeader(a, k[a])
            });
            this.$14 === "arraybuffer" && ("responseType" in d ? d.responseType = "arraybuffer" : "overrideMimeType" in d ? d.overrideMimeType("text/plain; charset=x-user-defined") : "setRequestHeader" in d && d.setRequestHeader("Accept-Charset", "x-user-defined"));
            this.$14 === "blob" && (d.responseType = this.$14);
            d.send(e)
        };
        c.abort = function(a) {
            this.$27(), this.$1 && (j || (j = b("ErrorGuard"))).applyWithGuard(this.$1, null, [a], {
        ...
        c.$26 = function() {
            this.$27(), this.$16 && (j || (j = b("ErrorGuard"))).applyWithGuard(this.$16, null, [], {
                name: "XHRRequest:_abortHandler"
            })
        };
        c.$29 = function(a) {
            if (this.$14)
                ...
                else if (this.$14 === "arraybuffer" && window.VBArray) return window.VBArray(a.responseBody).toArray();
        ...
        c.$23 = function(a) {
            ...
            return function() {
                var e, f = {
                    ...
                    errorRawTransport: d == null || (e = d.constructor) == null ? void 0 : e.name,
                    errorRawTransportStatus: 0
                };
                c.$8 ? (j || (j = b("ErrorGuard"))).applyWithGuard(a.bind(void 0, c.$8), null, [f], {
            ...
            return function() {
                ...
                if (f >= 2) {
                    ...
                    if (h != null) {
                        if (g) {
                            var m = 2 * 60 * 1e3 - 500;
                            h === "HTTP_TRANSPORT_ERROR" && c.$10 && c.$10 + m < (k || (k = b("performance"))).now() && (h = "HTTP_STREAM_TIMEOUT");
                            m = {
                                errorCode: h,
                                errorMsg: c.$29(e),
                            ...
                            c.$5 ? (j || (j = b("ErrorGuard"))).applyWithGuard(a.bind(void 0, c.$5), null, [m], {
                        ...
                        if (g || i.parseStreaming && f === 3) {
                            m = g ? a : d;
                            f = i != null && i.includeHeaders ? e.getAllResponseHeaders() : null;
                            e = c.$29(e);
                            c.$10 = (k || (k = b("performance"))).now();
                            var o = 200 * 1e3 * 1e3;
                            i.parseStreaming && typeof e === "string" && e.length > o && !n && (n = !0, b("FBLogger")("comet_infra").mustfix("Streaming reponse exceeding size limits and will OOM soon: %s", String(c.getURI())));
                            (j || (j = b("ErrorGuard"))).applyWithGuard(m.bind(void 0, i), null, [e, f, g], {
                                name: "XHRRequest:handler"
                            })
                        }
                    } else g && a(function() {});
                    g && (h != "HTTP_TRANSPORT_ERROR" && b("NetworkStatus").reportSuccess(), c.$28())
                }
            }
        };
        c.$24 = function(a) {
            o.loadedBytes = a.loaded, o.totalBytes = a.total, this.$19 && (j || (j = b("ErrorGuard"))).applyWithGuard(this.$19, null, [o], {
...
__d("lastx", ["invariant"], (function(a, b, c, d, e, f, g, h) {
    "use strict";

    function a(a) {
        var b = null;
        if (Array.isArray(a)) a.length && (b = {
            value: a[a.length - 1]
        });
        else
            for (a of a) b = b || {}, b.value = a;
        if (b) return b.value;
        h(0, 1145)
    }
    g["default"] = a
